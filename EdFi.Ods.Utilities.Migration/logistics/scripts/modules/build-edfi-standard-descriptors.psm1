...
function New-EdFiStandardDescriptorsPackage {
    param(
        ...
        [hashtable[]]
        $PackageFiles = @(
            @{ src = (Get-RepositoryResolvedPath "../../Ed-Fi-MigrationUtility/EdFi.Ods.Utilities.Migration/bin/%msbuild.buildConfiguration%/netcoreapp3.1/Descriptors/3.1/"); target = (Join-Path $OutputPath "any/netcoreapp3.1/Descriptors/3.1") }
        )
    )
