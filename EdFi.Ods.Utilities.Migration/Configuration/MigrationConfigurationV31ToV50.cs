...
{
    public class MigrationConfigurationV31ToV50 : MigrationConfigurationVersionSpecific
    {
        public override EdFiOdsVersion FromVersion => EdFiOdsVersion.V31;
        public override EdFiOdsVersion ToVersion => EdFiOdsVersion.V50;

        public override string MigrationScriptVersionSpecificDirectoryName => "v31_to_v50";
