...
(
       ...
       Id uniqueidentifier NOT NULL,
       ChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_CTEProgramServiceDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ChangeVersion)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       ChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_DisciplineIncidentParticipationCodeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ChangeVersion)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       ChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_GradePointAverageWeightSystemDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ChangeVersion)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       ChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_LearningStandardEquivalenceAssociation_TrackedDelete PRIMARY KEY CLUSTERED (ChangeVersion)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       ChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_LearningStandardEquivalenceStrengthDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ChangeVersion)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       ChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_LearningStandardScopeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ChangeVersion)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       ChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_ParticipationStatusDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ChangeVersion)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       ChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_PlatformTypeDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ChangeVersion)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       ChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_StaffDisciplineIncidentAssociation_TrackedDelete PRIMARY KEY CLUSTERED (ChangeVersion)
)
...
(
       ...
       Id uniqueidentifier NOT NULL,
       ChangeVersion bigint NOT NULL,
       CONSTRAINT PK_edfi_TitleIPartAProgramServiceDescriptor_TrackedDelete PRIMARY KEY CLUSTERED (ChangeVersion)
)
