...
N'CREATE TRIGGER [edfi].[edfi_CTEProgramServiceDescriptor_TR_DeleteTracking] ON [edfi].[CTEProgramServiceDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
...
BEGIN
    ...
    EXEC dbo.sp_executesql @statement = 
N'CREATE TRIGGER [edfi].[edfi_DisciplineIncidentParticipationCodeDescriptor_TR_DeleteTracking] ON [edfi].[DisciplineIncidentParticipationCodeDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
...
BEGIN
    ...
    EXEC dbo.sp_executesql @statement = 
N'CREATE TRIGGER [edfi].[edfi_GradePointAverageWeightSystemDescriptor_TR_DeleteTracking] ON [edfi].[GradePointAverageWeightSystemDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
...
BEGIN
    ...
    EXEC dbo.sp_executesql @statement = 
N'CREATE TRIGGER [edfi].[edfi_LearningStandardEquivalenceAssociation_TR_UpdateChangeVersion] ON [edfi].[LearningStandardEquivalenceAssociation] AFTER UPDATE AS
BEGIN
    SET NOCOUNT ON;
...
BEGIN
    ...
    EXEC dbo.sp_executesql @statement = 
N'CREATE TRIGGER [edfi].[edfi_LearningStandardEquivalenceAssociation_TR_DeleteTracking] ON [edfi].[LearningStandardEquivalenceAssociation] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
...
BEGIN
    ...
    EXEC dbo.sp_executesql @statement = 
N'CREATE TRIGGER [edfi].[edfi_LearningStandardEquivalenceStrengthDescriptor_TR_DeleteTracking] ON [edfi].[LearningStandardEquivalenceStrengthDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
...
BEGIN
    ...
    EXEC dbo.sp_executesql @statement = 
N'CREATE TRIGGER [edfi].[edfi_LearningStandardScopeDescriptor_TR_DeleteTracking] ON [edfi].[LearningStandardScopeDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
...
BEGIN
    ...
    EXEC dbo.sp_executesql @statement = 
N'CREATE TRIGGER [edfi].[edfi_ParticipationStatusDescriptor_TR_DeleteTracking] ON [edfi].[ParticipationStatusDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
...
BEGIN
    ...
    EXEC dbo.sp_executesql @statement = 
N'CREATE TRIGGER [edfi].[edfi_PlatformTypeDescriptor_TR_DeleteTracking] ON [edfi].[PlatformTypeDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
...
BEGIN
    ...
    EXEC dbo.sp_executesql @statement = 
N'CREATE TRIGGER [edfi].[edfi_StaffDisciplineIncidentAssociation_TR_UpdateChangeVersion] ON [edfi].[StaffDisciplineIncidentAssociation] AFTER UPDATE AS
BEGIN
    SET NOCOUNT ON;
...
BEGIN
    ...
    EXEC dbo.sp_executesql @statement = 
N'CREATE TRIGGER [edfi].[edfi_StaffDisciplineIncidentAssociation_TR_DeleteTracking] ON [edfi].[StaffDisciplineIncidentAssociation] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
...
BEGIN
    ...
    EXEC dbo.sp_executesql @statement = 
N'CREATE TRIGGER [edfi].[edfi_TitleIPartAProgramServiceDescriptor_TR_DeleteTracking] ON [edfi].[TitleIPartAProgramServiceDescriptor] AFTER DELETE AS
BEGIN
    IF @@rowcount = 0 
        RETURN
