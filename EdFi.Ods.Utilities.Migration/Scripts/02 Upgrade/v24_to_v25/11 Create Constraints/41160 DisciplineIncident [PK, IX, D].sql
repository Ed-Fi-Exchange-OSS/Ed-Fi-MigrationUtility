...
GO
PRINT N'Creating index [FK_DisciplineIncident_IncidentLocationType] on [edfi].[DisciplineIncident]'
GO
CREATE NONCLUSTERED INDEX [FK_DisciplineIncident_IncidentLocationType] ON [edfi].[DisciplineIncident] ([IncidentLocationTypeId])
GO
