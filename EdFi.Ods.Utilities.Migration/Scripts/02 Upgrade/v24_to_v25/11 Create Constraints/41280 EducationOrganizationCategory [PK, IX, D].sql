...
GO
ALTER TABLE [edfi].[EducationOrganizationCategory] ADD CONSTRAINT [EducationOrganizationCategory_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [EducationOrganizationCategoryTypeId])
GO
PRINT N'Creating index [FK_EducationOrganizationCategory_EducationOrganizationCategoryType] on [edfi].[EducationOrganizationCategory]'
GO
CREATE NONCLUSTERED INDEX [FK_EducationOrganizationCategory_EducationOrganizationCategoryType] ON [edfi].[EducationOrganizationCategory] ([EducationOrganizationCategoryTypeId])
GO
