...
GO
ALTER TABLE [edfi].[StudentSchoolAssociation] ADD CONSTRAINT [StudentSchoolAssociation_PK] PRIMARY KEY CLUSTERED  ([StudentUSI], [SchoolId], [EntryDate])
GO
...
GO
PRINT N'Creating index [FK_StudentSchoolAssociation_EntryGradeLevelReasonType] on [edfi].[StudentSchoolAssociation]'
GO
CREATE NONCLUSTERED INDEX [FK_StudentSchoolAssociation_EntryGradeLevelReasonType] ON [edfi].[StudentSchoolAssociation] ([EntryGradeLevelReasonTypeId])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_StudentSchoolAssociation_GraduationPlan] ON [edfi].[StudentSchoolAssociation] ([GraduationPlanTypeDescriptorId], [EducationOrganizationId], [GraduationSchoolYear])
GO
