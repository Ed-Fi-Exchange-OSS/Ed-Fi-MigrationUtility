...
GO
PRINT N'Creating index [FK_Assessment_AssessmentFamily] on [edfi].[Assessment]'
GO
CREATE NONCLUSTERED INDEX [FK_Assessment_AssessmentFamily] ON [edfi].[Assessment] ([AssessmentFamilyTitle])
GO
PRINT N'Creating index [FK_Assessment_AssessmentPeriodDescriptor] on [edfi].[Assessment]'
GO
CREATE NONCLUSTERED INDEX [FK_Assessment_AssessmentPeriodDescriptor] ON [edfi].[Assessment] ([AssessmentPeriodDescriptorId])
GO
