...
GO
ALTER TABLE [edfi].[StaffSchoolAssociation] ADD CONSTRAINT [StaffSchoolAssociation_PK] PRIMARY KEY CLUSTERED  ([StaffUSI], [ProgramAssignmentDescriptorId], [SchoolId])
GO
