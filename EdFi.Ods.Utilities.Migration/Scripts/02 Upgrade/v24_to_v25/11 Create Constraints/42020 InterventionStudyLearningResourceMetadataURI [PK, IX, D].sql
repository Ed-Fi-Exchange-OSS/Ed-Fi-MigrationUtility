...
GO
ALTER TABLE [edfi].[InterventionStudyLearningResourceMetadataURI] ADD CONSTRAINT [InterventionStudyLearningResourceMetadataURI_PK] PRIMARY KEY CLUSTERED  ([InterventionStudyIdentificationCode], [EducationOrganizationId], [LearningResourceMetadataURI])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_InterventionStudyLearningResourceMetadataURI_InterventionStudy] ON [edfi].[InterventionStudyLearningResourceMetadataURI] ([InterventionStudyIdentificationCode], [EducationOrganizationId])
GO
