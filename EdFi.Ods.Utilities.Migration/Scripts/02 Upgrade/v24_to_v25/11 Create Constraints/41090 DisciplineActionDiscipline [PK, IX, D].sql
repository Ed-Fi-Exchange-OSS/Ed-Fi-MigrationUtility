...
GO
ALTER TABLE [edfi].[DisciplineActionDiscipline] ADD CONSTRAINT [DisciplineActionDiscipline_PK] PRIMARY KEY CLUSTERED  ([StudentUSI], [DisciplineActionIdentifier], [DisciplineDate], [DisciplineDescriptorId])
GO
PRINT N'Creating index [FK_DisciplineActionDiscipline_DisciplineAction] on [edfi].[DisciplineActionDiscipline]'
GO
CREATE NONCLUSTERED INDEX [FK_DisciplineActionDiscipline_DisciplineAction] ON [edfi].[DisciplineActionDiscipline] ([DisciplineActionIdentifier], [StudentUSI], [DisciplineDate])
GO
