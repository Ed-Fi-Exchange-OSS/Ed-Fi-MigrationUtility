...
GO
ALTER TABLE [edfi].[ParentOtherName] ADD CONSTRAINT [ParentOtherName_PK] PRIMARY KEY CLUSTERED  ([ParentUSI], [OtherNameTypeId])
GO
PRINT N'Creating index [FK_ParentOtherName_OtherNameType] on [edfi].[ParentOtherName]'
GO
CREATE NONCLUSTERED INDEX [FK_ParentOtherName_OtherNameType] ON [edfi].[ParentOtherName] ([OtherNameTypeId])
GO
