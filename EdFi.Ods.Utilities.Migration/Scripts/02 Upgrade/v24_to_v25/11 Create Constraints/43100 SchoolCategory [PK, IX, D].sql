...
GO
ALTER TABLE [edfi].[SchoolCategory] ADD CONSTRAINT [SchoolCategory_PK] PRIMARY KEY CLUSTERED  ([SchoolId], [SchoolCategoryTypeId])
GO
PRINT N'Creating index [FK_SchoolCategory_SchoolCategoryType] on [edfi].[SchoolCategory]'
GO
CREATE NONCLUSTERED INDEX [FK_SchoolCategory_SchoolCategoryType] ON [edfi].[SchoolCategory] ([SchoolCategoryTypeId])
GO
