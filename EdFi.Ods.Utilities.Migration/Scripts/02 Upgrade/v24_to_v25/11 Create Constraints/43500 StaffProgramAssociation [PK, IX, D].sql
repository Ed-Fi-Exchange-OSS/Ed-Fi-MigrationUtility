...
GO
ALTER TABLE [edfi].[StaffProgramAssociation] ADD CONSTRAINT [StaffProgramAssociation_PK] PRIMARY KEY CLUSTERED  ([ProgramEducationOrganizationId], [ProgramTypeId], [StaffUSI], [BeginDate], [ProgramName])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_StaffProgramAssociation_Program] ON [edfi].[StaffProgramAssociation] ([ProgramEducationOrganizationId], [ProgramTypeId], [ProgramName])
GO
