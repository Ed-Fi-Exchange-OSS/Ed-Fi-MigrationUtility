...
GO
PRINT N'Creating index [FK_AssessmentContentStandard_Assessment] on [edfi].[AssessmentContentStandard]'
GO
CREATE NONCLUSTERED INDEX [FK_AssessmentContentStandard_Assessment] ON [edfi].[AssessmentContentStandard] ([AssessmentIdentifier], [Namespace])
GO
...
GO
PRINT N'Creating index [FK_AssessmentContentStandard_PublicationStatusType] on [edfi].[AssessmentContentStandard]'
GO
CREATE NONCLUSTERED INDEX [FK_AssessmentContentStandard_PublicationStatusType] ON [edfi].[AssessmentContentStandard] ([PublicationStatusTypeId])
GO
