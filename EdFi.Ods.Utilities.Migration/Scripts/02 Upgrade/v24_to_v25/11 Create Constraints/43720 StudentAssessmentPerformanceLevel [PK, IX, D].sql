...
GO
ALTER TABLE [edfi].[StudentAssessmentPerformanceLevel] ADD CONSTRAINT [StudentAssessmentPerformanceLevel_PK] PRIMARY KEY CLUSTERED  ([AssessmentIdentifier], [AssessmentReportingMethodTypeId], [Namespace], [PerformanceLevelDescriptorId], [StudentAssessmentIdentifier], [StudentUSI])
GO
...
GO
PRINT N'Creating index [FK_StudentAssessmentPerformanceLevel_AssessmentReportingMethodType] on [edfi].[StudentAssessmentPerformanceLevel]'
GO
CREATE NONCLUSTERED INDEX [FK_StudentAssessmentPerformanceLevel_AssessmentReportingMethodType] ON [edfi].[StudentAssessmentPerformanceLevel] ([AssessmentReportingMethodTypeId])
GO
