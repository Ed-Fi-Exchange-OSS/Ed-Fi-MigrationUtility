...
GO
ALTER TABLE [edfi].[AssessmentContentStandard] ADD CONSTRAINT [FK_AssessmentContentStandard_PublicationStatusType] FOREIGN KEY ([PublicationStatusTypeId]) REFERENCES [edfi].[PublicationStatusType] ([PublicationStatusTypeId])
GO
