...
GO
ALTER TABLE [edfi].[CompetencyObjective] ADD CONSTRAINT [CompetencyObjective_PK] PRIMARY KEY CLUSTERED  ([Objective], [ObjectiveGradeLevelDescriptorId], [EducationOrganizationId])
GO
