...
GO
ALTER TABLE [edfi].[CalendarEventDescriptor] ADD CONSTRAINT [FK_CalendarEventDescriptor_CalendarEventType] FOREIGN KEY ([CalendarEventTypeId]) REFERENCES [edfi].[CalendarEventType] ([CalendarEventTypeId])
GO
