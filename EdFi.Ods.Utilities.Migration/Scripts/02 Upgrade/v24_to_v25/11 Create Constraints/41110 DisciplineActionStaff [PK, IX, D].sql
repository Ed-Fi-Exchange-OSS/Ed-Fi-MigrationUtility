...
GO
ALTER TABLE [edfi].[DisciplineActionStaff] ADD CONSTRAINT [DisciplineActionStaff_PK] PRIMARY KEY CLUSTERED  ([StudentUSI], [DisciplineActionIdentifier], [DisciplineDate], [StaffUSI])
GO
PRINT N'Creating index [FK_DisciplineActionStaff_DisciplineAction] on [edfi].[DisciplineActionStaff]'
GO
CREATE NONCLUSTERED INDEX [FK_DisciplineActionStaff_DisciplineAction] ON [edfi].[DisciplineActionStaff] ([DisciplineActionIdentifier], [StudentUSI], [DisciplineDate])
GO
