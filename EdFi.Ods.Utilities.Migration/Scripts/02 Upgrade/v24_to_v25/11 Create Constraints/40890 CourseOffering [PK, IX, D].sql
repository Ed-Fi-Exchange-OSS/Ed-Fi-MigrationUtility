...
GO
ALTER TABLE [edfi].[CourseOffering] ADD CONSTRAINT [CourseOffering_PK] PRIMARY KEY CLUSTERED  ([LocalCourseCode], [SchoolId], [SchoolYear], [TermDescriptorId])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_CourseOffering_Course] ON [edfi].[CourseOffering] ([EducationOrganizationId], [CourseCode])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_CourseOffering_Session] ON [edfi].[CourseOffering] ([SchoolId], [SchoolYear], [TermDescriptorId])
GO
