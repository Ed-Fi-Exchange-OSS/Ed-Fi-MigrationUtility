...
GO
PRINT N'Creating index [FK_LearningStandardContentStandard_LearningStandard] on [edfi].[LearningStandardContentStandard]'
GO
CREATE NONCLUSTERED INDEX [FK_LearningStandardContentStandard_LearningStandard] ON [edfi].[LearningStandardContentStandard] ([LearningStandardId])
GO
...
GO
PRINT N'Creating index [FK_LearningStandardContentStandard_PublicationStatusType] on [edfi].[LearningStandardContentStandard]'
GO
CREATE NONCLUSTERED INDEX [FK_LearningStandardContentStandard_PublicationStatusType] ON [edfi].[LearningStandardContentStandard] ([PublicationStatusTypeId])
GO
