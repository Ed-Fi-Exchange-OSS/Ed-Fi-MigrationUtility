...
GO
ALTER TABLE [edfi].[StudentVisa] ADD CONSTRAINT [StudentVisa_PK] PRIMARY KEY CLUSTERED  ([StudentUSI], [VisaTypeId])
GO
...
GO
PRINT N'Creating index [FK_StudentVisa_VisaType] on [edfi].[StudentVisa]'
GO
CREATE NONCLUSTERED INDEX [FK_StudentVisa_VisaType] ON [edfi].[StudentVisa] ([VisaTypeId])
GO
