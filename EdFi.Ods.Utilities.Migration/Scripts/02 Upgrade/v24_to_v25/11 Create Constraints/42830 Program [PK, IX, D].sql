...
GO
ALTER TABLE [edfi].[Program] ADD CONSTRAINT [Program_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [ProgramTypeId], [ProgramName])
GO
...
GO
PRINT N'Creating index [FK_Program_ProgramSponsorType] on [edfi].[Program]'
GO
CREATE NONCLUSTERED INDEX [FK_Program_ProgramSponsorType] ON [edfi].[Program] ([ProgramSponsorTypeId])
GO
PRINT N'Creating index [FK_Program_ProgramType] on [edfi].[Program]'
GO
CREATE NONCLUSTERED INDEX [FK_Program_ProgramType] ON [edfi].[Program] ([ProgramTypeId])
GO
