...
GO
ALTER TABLE [edfi].[EducationOrganizationInstitutionTelephone] ADD CONSTRAINT [EducationOrganizationInstitutionTelephone_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [InstitutionTelephoneNumberTypeId])
GO
...
GO
PRINT N'Creating index [FK_EducationOrganizationInstitutionTelephone_InstitutionTelephoneNumberType] on [edfi].[EducationOrganizationInstitutionTelephone]'
GO
CREATE NONCLUSTERED INDEX [FK_EducationOrganizationInstitutionTelephone_InstitutionTelephoneNumberType] ON [edfi].[EducationOrganizationInstitutionTelephone] ([InstitutionTelephoneNumberTypeId])
GO
