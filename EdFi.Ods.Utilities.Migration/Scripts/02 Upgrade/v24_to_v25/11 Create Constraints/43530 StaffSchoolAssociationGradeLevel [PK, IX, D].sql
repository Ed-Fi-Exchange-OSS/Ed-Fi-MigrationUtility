...
GO
ALTER TABLE [edfi].[StaffSchoolAssociationGradeLevel] ADD CONSTRAINT [StaffSchoolAssociationGradeLevel_PK] PRIMARY KEY CLUSTERED  ([StaffUSI], [ProgramAssignmentDescriptorId], [SchoolId], [GradeLevelDescriptorId])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_StaffSchoolAssociationGradeLevel_StaffSchoolAssociation] ON [edfi].[StaffSchoolAssociationGradeLevel] ([StaffUSI], [ProgramAssignmentDescriptorId], [SchoolId])
GO
