...
GO
CREATE NONCLUSTERED INDEX [FK_GraduationPlanRequiredAssessment_GraduationPlan] ON [edfi].[GraduationPlanRequiredAssessment] ([GraduationPlanTypeDescriptorId], [EducationOrganizationId], [GraduationSchoolYear])
GO
