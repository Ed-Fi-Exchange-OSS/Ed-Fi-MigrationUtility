...
GO
ALTER TABLE [edfi].[AssessmentSection] ADD CONSTRAINT [AssessmentSection_PK] PRIMARY KEY CLUSTERED  ([AssessmentIdentifier], [ClassPeriodName], [ClassroomIdentificationCode], [LocalCourseCode], [Namespace], [SchoolId], [SchoolYear], [SequenceOfCourse], [TermDescriptorId], [UniqueSectionCode])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_AssessmentSection_Section] ON [edfi].[AssessmentSection] ([SchoolId], [ClassPeriodName], [ClassroomIdentificationCode], [LocalCourseCode], [TermDescriptorId], [SchoolYear], [UniqueSectionCode], [SequenceOfCourse])
GO
