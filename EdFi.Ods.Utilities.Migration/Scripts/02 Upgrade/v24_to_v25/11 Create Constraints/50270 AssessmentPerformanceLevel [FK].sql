...
GO
ALTER TABLE [edfi].[AssessmentPerformanceLevel] ADD CONSTRAINT [FK_AssessmentPerformanceLevel_AssessmentReportingMethodType] FOREIGN KEY ([AssessmentReportingMethodTypeId]) REFERENCES [edfi].[AssessmentReportingMethodType] ([AssessmentReportingMethodTypeId])
GO
...
GO
ALTER TABLE [edfi].[AssessmentPerformanceLevel] ADD CONSTRAINT [FK_AssessmentPerformanceLevel_ResultDatatypeType] FOREIGN KEY ([ResultDatatypeTypeId]) REFERENCES [edfi].[ResultDatatypeType] ([ResultDatatypeTypeId])
GO
