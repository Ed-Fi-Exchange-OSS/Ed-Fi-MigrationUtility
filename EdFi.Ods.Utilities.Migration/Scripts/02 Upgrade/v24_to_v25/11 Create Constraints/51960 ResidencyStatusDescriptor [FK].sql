...
GO
ALTER TABLE [edfi].[ResidencyStatusDescriptor] ADD CONSTRAINT [FK_ResidencyStatusDescriptor_ResidencyStatusType] FOREIGN KEY ([ResidencyStatusTypeId]) REFERENCES [edfi].[ResidencyStatusType] ([ResidencyStatusTypeId])
GO
