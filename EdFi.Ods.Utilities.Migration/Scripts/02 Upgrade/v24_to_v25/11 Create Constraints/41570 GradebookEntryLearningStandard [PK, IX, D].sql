...
GO
ALTER TABLE [edfi].[GradebookEntryLearningStandard] ADD CONSTRAINT [GradebookEntryLearningStandard_PK] PRIMARY KEY CLUSTERED  ([SchoolId], [ClassPeriodName], [ClassroomIdentificationCode], [GradebookEntryTitle], [DateAssigned], [LearningStandardId], [SchoolYear], [LocalCourseCode], [TermDescriptorId], [UniqueSectionCode], [SequenceOfCourse])
GO
PRINT N'Creating index [FK_GradebookEntryLearningStandard_GradebookEntry] on [edfi].[GradebookEntryLearningStandard]'
GO
CREATE NONCLUSTERED INDEX [FK_GradebookEntryLearningStandard_GradebookEntry] ON [edfi].[GradebookEntryLearningStandard] ([GradebookEntryTitle], [ClassroomIdentificationCode], [SchoolId], [ClassPeriodName], [LocalCourseCode], [SchoolYear], [TermDescriptorId], [UniqueSectionCode], [SequenceOfCourse], [DateAssigned])
GO
