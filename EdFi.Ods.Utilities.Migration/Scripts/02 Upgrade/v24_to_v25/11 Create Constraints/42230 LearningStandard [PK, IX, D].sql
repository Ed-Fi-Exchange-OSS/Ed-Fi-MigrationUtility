...
GO
PRINT N'Creating index [FK_LearningStandard_AcademicSubjectDescriptor] on [edfi].[LearningStandard]'
GO
CREATE NONCLUSTERED INDEX [FK_LearningStandard_AcademicSubjectDescriptor] ON [edfi].[LearningStandard] ([AcademicSubjectDescriptorId])
GO
