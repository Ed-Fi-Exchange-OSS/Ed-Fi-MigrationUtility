...
GO
ALTER TABLE [edfi].[GraduationPlan] ADD CONSTRAINT [FK_GraduationPlan_CreditType] FOREIGN KEY ([TotalRequiredCreditTypeId]) REFERENCES [edfi].[CreditType] ([CreditTypeId])
GO
