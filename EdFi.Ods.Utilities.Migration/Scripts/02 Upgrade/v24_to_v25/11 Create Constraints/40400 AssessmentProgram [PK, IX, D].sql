...
GO
ALTER TABLE [edfi].[AssessmentProgram] ADD CONSTRAINT [AssessmentProgram_PK] PRIMARY KEY CLUSTERED  ([AssessmentIdentifier], [EducationOrganizationId], [Namespace], [ProgramName], [ProgramTypeId])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_AssessmentProgram_Program] ON [edfi].[AssessmentProgram] ([EducationOrganizationId], [ProgramTypeId], [ProgramName])
GO
