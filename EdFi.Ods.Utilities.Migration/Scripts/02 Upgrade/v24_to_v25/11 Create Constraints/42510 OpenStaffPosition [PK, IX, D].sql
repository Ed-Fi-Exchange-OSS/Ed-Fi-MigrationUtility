...
GO
ALTER TABLE [edfi].[OpenStaffPosition] ADD CONSTRAINT [OpenStaffPosition_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [EmploymentStatusDescriptorId], [StaffClassificationDescriptorId], [RequisitionNumber], [DatePosted])
GO
...
GO
PRINT N'Creating index [FK_OpenStaffPosition_PostingResultType] on [edfi].[OpenStaffPosition]'
GO
CREATE NONCLUSTERED INDEX [FK_OpenStaffPosition_PostingResultType] ON [edfi].[OpenStaffPosition] ([PostingResultTypeId])
GO
