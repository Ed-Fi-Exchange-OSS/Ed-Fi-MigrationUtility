...
GO
ALTER TABLE [edfi].[StaffCohortAssociation] ADD CONSTRAINT [StaffCohortAssociation_PK] PRIMARY KEY CLUSTERED  ([StaffUSI], [EducationOrganizationId], [CohortIdentifier], [BeginDate])
GO
