...
GO
ALTER TABLE [edfi].[CourseLearningStandard] ADD CONSTRAINT [CourseLearningStandard_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [CourseCode], [LearningStandardId])
GO
PRINT N'Creating index [FK_CourseLearningStandard_Course] on [edfi].[CourseLearningStandard]'
GO
CREATE NONCLUSTERED INDEX [FK_CourseLearningStandard_Course] ON [edfi].[CourseLearningStandard] ([EducationOrganizationId], [CourseCode])
GO
