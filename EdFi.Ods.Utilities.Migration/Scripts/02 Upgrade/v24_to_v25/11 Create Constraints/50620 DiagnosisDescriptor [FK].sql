...
GO
ALTER TABLE [edfi].[DiagnosisDescriptor] ADD CONSTRAINT [FK_DiagnosisDescriptor_DiagnosisType] FOREIGN KEY ([DiagnosisTypeId]) REFERENCES [edfi].[DiagnosisType] ([DiagnosisTypeId])
GO
