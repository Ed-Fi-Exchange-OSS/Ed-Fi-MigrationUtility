...
PRINT N'Updating LearningObjective key references in [edfi].[LearningObjectiveContentStandard]'
GO
...
FROM [edfi].[LearningObjectiveContentStandard] o
...
ALTER TABLE [edfi].[LearningObjectiveContentStandard] DROP
	COLUMN [Objective],
