...
PRINT N'Updating LearningObjective key references in [edfi].[LearningObjectiveLearningStandard]'
GO
...
UPDATE [edfi].[LearningObjectiveLearningStandard]
SET
	[LearningObjectiveId] = m.[LearningObjectiveId],
	[Namespace] = m.[Namespace]
FROM [edfi].[LearningObjectiveLearningStandard] o
...
ALTER TABLE [edfi].[LearningObjectiveLearningStandard] DROP
	COLUMN [Objective],
