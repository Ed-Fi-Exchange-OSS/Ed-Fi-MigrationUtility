...
PRINT N'Updating [edfi].[InterventionEffectivenessRatingType]'
GO

UPDATE [edfi].[InterventionEffectivenessRatingType]
SET [CodeValue] = LEFT(COALESCE (NULLIF([ShortDescription], ''''), NULLIF([Description], ''''), [ShortDescription]), 50)
WHERE [CodeValue] IS NULL
GO

ALTER TABLE [edfi].[InterventionEffectivenessRatingType]
