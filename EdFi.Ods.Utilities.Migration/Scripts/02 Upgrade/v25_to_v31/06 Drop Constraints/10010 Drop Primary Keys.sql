...
EXEC [migration_tempdata].[sp_DropPrimaryKeys] 'edfi', 'AssessmentAcademicSubject'
GO

EXEC [migration_tempdata].[sp_DropPrimaryKeys] 'edfi', 'AssessmentAssessedGradeLevel'
GO
...
EXEC [migration_tempdata].[sp_DropPrimaryKeys] 'edfi', 'LearningObjectiveAcademicSubject'
GO
...
EXEC [migration_tempdata].[sp_DropPrimaryKeys] 'edfi', 'LearningObjectiveGradeLevel'
GO
