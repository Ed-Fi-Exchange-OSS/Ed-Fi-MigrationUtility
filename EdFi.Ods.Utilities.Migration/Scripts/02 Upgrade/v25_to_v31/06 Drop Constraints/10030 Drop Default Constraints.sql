...
EXEC [migration_tempdata].[sp_DropDefaultConstraints] 'edfi', 'AssessmentAcademicSubject'
GO

EXEC [migration_tempdata].[sp_DropDefaultConstraints] 'edfi', 'AssessmentAssessedGradeLevel'
GO
...
EXEC [migration_tempdata].[sp_DropDefaultConstraints] 'edfi', 'LearningObjectiveAcademicSubject'
GO
...
EXEC [migration_tempdata].[sp_DropDefaultConstraints] 'edfi', 'LearningObjectiveGradeLevel'
GO
