...
GO
ALTER TABLE [edfi].[StaffVisa] ADD CONSTRAINT [StaffVisa_PK] PRIMARY KEY CLUSTERED  ([StaffUSI], [VisaDescriptorId])
GO
...
PRINT N'Creating index [FK_StaffVisa_VisaDescriptor] on [edfi].[StaffVisa]'
GO
CREATE NONCLUSTERED INDEX [FK_StaffVisa_VisaDescriptor] ON [edfi].[StaffVisa] ([VisaDescriptorId])
GO
