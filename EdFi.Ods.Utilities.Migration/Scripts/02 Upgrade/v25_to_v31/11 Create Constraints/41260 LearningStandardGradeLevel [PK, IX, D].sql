...
GO
ALTER TABLE [edfi].[LearningStandardGradeLevel] ADD CONSTRAINT [LearningStandardGradeLevel_PK] PRIMARY KEY CLUSTERED  ([GradeLevelDescriptorId], [LearningStandardId])
GO
