...
GO
ALTER TABLE [edfi].[ProgramLearningStandard] ADD CONSTRAINT [ProgramLearningStandard_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [LearningStandardId], [ProgramName], [ProgramTypeDescriptorId])
GO

PRINT N'Creating index [FK_ProgramLearningStandard_Program] on [edfi].[ProgramLearningStandard]'
GO
CREATE NONCLUSTERED INDEX [FK_ProgramLearningStandard_Program] ON [edfi].[ProgramLearningStandard] ([EducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId])
GO
