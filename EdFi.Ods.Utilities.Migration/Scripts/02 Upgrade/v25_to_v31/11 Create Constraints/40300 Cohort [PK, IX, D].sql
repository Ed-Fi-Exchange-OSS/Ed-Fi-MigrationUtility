...
PRINT N'Creating index [FK_Cohort_CohortScopeDescriptor] on [edfi].[Cohort]'
GO
CREATE NONCLUSTERED INDEX [FK_Cohort_CohortScopeDescriptor] ON [edfi].[Cohort] ([CohortScopeDescriptorId])
GO

PRINT N'Creating index [FK_Cohort_CohortTypeDescriptor] on [edfi].[Cohort]'
GO
CREATE NONCLUSTERED INDEX [FK_Cohort_CohortTypeDescriptor] ON [edfi].[Cohort] ([CohortTypeDescriptorId])
GO
