...
GO
ALTER TABLE [edfi].[CourseCompetencyLevel] ADD CONSTRAINT [CourseCompetencyLevel_PK] PRIMARY KEY CLUSTERED  ([CompetencyLevelDescriptorId], [CourseCode], [EducationOrganizationId])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_CourseCompetencyLevel_Course] ON [edfi].[CourseCompetencyLevel] ([CourseCode], [EducationOrganizationId])
GO
