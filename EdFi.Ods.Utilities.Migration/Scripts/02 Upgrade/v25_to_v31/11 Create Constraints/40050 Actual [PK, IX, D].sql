...
GO
ALTER TABLE [edfi].[Actual] ADD CONSTRAINT [Actual_PK] PRIMARY KEY CLUSTERED  ([AccountIdentifier], [AsOfDate], [EducationOrganizationId], [FiscalYear])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_Actual_Account] ON [edfi].[Actual] ([AccountIdentifier], [EducationOrganizationId], [FiscalYear])
GO
