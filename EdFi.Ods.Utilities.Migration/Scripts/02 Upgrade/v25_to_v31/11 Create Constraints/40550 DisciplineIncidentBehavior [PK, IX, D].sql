...
GO
ALTER TABLE [edfi].[DisciplineIncidentBehavior] ADD CONSTRAINT [DisciplineIncidentBehavior_PK] PRIMARY KEY CLUSTERED  ([BehaviorDescriptorId], [IncidentIdentifier], [SchoolId])
GO
