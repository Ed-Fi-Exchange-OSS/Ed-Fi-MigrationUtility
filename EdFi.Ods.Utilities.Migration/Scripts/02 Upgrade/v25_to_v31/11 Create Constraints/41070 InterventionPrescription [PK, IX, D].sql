...
GO
ALTER TABLE [edfi].[InterventionPrescription] ADD CONSTRAINT [InterventionPrescription_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [InterventionPrescriptionIdentificationCode])
GO
...
PRINT N'Creating index [FK_InterventionPrescription_DeliveryMethodDescriptor] on [edfi].[InterventionPrescription]'
GO
CREATE NONCLUSTERED INDEX [FK_InterventionPrescription_DeliveryMethodDescriptor] ON [edfi].[InterventionPrescription] ([DeliveryMethodDescriptorId])
GO
...
PRINT N'Creating index [FK_InterventionPrescription_InterventionClassDescriptor] on [edfi].[InterventionPrescription]'
GO
CREATE NONCLUSTERED INDEX [FK_InterventionPrescription_InterventionClassDescriptor] ON [edfi].[InterventionPrescription] ([InterventionClassDescriptorId])
GO
