...
GO
ALTER TABLE [edfi].[StaffOtherName] ADD CONSTRAINT [StaffOtherName_PK] PRIMARY KEY CLUSTERED  ([OtherNameTypeDescriptorId], [StaffUSI])
GO

PRINT N'Creating index [FK_StaffOtherName_OtherNameTypeDescriptor] on [edfi].[StaffOtherName]'
GO
CREATE NONCLUSTERED INDEX [FK_StaffOtherName_OtherNameTypeDescriptor] ON [edfi].[StaffOtherName] ([OtherNameTypeDescriptorId])
GO
