...
GO
ALTER TABLE [edfi].[InterventionAppropriateGradeLevel] ADD CONSTRAINT [InterventionAppropriateGradeLevel_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [GradeLevelDescriptorId], [InterventionIdentificationCode])
GO

PRINT N'Creating index [FK_InterventionAppropriateGradeLevel_Intervention] on [edfi].[InterventionAppropriateGradeLevel]'
GO
CREATE NONCLUSTERED INDEX [FK_InterventionAppropriateGradeLevel_Intervention] ON [edfi].[InterventionAppropriateGradeLevel] ([EducationOrganizationId], [InterventionIdentificationCode])
GO
