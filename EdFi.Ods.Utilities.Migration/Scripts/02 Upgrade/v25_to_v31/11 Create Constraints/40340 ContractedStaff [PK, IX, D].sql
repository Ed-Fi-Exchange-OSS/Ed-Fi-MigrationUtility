...
GO
ALTER TABLE [edfi].[ContractedStaff] ADD CONSTRAINT [ContractedStaff_PK] PRIMARY KEY CLUSTERED  ([AccountIdentifier], [AsOfDate], [EducationOrganizationId], [FiscalYear], [StaffUSI])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_ContractedStaff_Account] ON [edfi].[ContractedStaff] ([AccountIdentifier], [EducationOrganizationId], [FiscalYear])
GO
