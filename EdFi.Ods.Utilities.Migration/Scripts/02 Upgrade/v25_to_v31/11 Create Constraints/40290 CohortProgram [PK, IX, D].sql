...
GO
ALTER TABLE [edfi].[CohortProgram] ADD CONSTRAINT [CohortProgram_PK] PRIMARY KEY CLUSTERED  ([CohortIdentifier], [EducationOrganizationId], [ProgramEducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_CohortProgram_Program] ON [edfi].[CohortProgram] ([ProgramEducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId])
GO
