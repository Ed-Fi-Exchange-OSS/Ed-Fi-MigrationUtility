...
GO
ALTER TABLE [edfi].[Intervention] ADD CONSTRAINT [Intervention_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [InterventionIdentificationCode])
GO
...
PRINT N'Creating index [FK_Intervention_DeliveryMethodDescriptor] on [edfi].[Intervention]'
GO
CREATE NONCLUSTERED INDEX [FK_Intervention_DeliveryMethodDescriptor] ON [edfi].[Intervention] ([DeliveryMethodDescriptorId])
GO
...
PRINT N'Creating index [FK_Intervention_InterventionClassDescriptor] on [edfi].[Intervention]'
GO
CREATE NONCLUSTERED INDEX [FK_Intervention_InterventionClassDescriptor] ON [edfi].[Intervention] ([InterventionClassDescriptorId])
GO
