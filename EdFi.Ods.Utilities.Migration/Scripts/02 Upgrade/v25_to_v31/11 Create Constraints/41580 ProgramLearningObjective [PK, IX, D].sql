...
GO
ALTER TABLE [edfi].[ProgramLearningObjective] ADD CONSTRAINT [ProgramLearningObjective_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [LearningObjectiveId], [Namespace], [ProgramName], [ProgramTypeDescriptorId])
GO

PRINT N'Creating index [FK_ProgramLearningObjective_Program] on [edfi].[ProgramLearningObjective]'
GO
CREATE NONCLUSTERED INDEX [FK_ProgramLearningObjective_Program] ON [edfi].[ProgramLearningObjective] ([EducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId])
GO
