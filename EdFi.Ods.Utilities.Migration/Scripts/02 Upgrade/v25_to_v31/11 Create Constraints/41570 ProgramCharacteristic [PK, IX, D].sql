...
GO
ALTER TABLE [edfi].[ProgramCharacteristic] ADD CONSTRAINT [ProgramCharacteristic_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [ProgramCharacteristicDescriptorId], [ProgramName], [ProgramTypeDescriptorId])
GO

PRINT N'Creating index [FK_ProgramCharacteristic_Program] on [edfi].[ProgramCharacteristic]'
GO
CREATE NONCLUSTERED INDEX [FK_ProgramCharacteristic_Program] ON [edfi].[ProgramCharacteristic] ([EducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId])
GO
