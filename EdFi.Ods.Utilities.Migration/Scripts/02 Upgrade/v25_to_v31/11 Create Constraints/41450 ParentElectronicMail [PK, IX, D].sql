...
GO
ALTER TABLE [edfi].[ParentElectronicMail] ADD CONSTRAINT [ParentElectronicMail_PK] PRIMARY KEY CLUSTERED  ([ElectronicMailTypeDescriptorId], [ParentUSI])
GO

PRINT N'Creating index [FK_ParentElectronicMail_ElectronicMailTypeDescriptor] on [edfi].[ParentElectronicMail]'
GO
CREATE NONCLUSTERED INDEX [FK_ParentElectronicMail_ElectronicMailTypeDescriptor] ON [edfi].[ParentElectronicMail] ([ElectronicMailTypeDescriptorId])
GO
