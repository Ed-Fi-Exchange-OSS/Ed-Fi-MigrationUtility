...
GO
ALTER TABLE [edfi].[StaffInternationalAddress] ADD CONSTRAINT [StaffInternationalAddress_PK] PRIMARY KEY CLUSTERED  ([AddressTypeDescriptorId], [StaffUSI])
GO

PRINT N'Creating index [FK_StaffInternationalAddress_AddressTypeDescriptor] on [edfi].[StaffInternationalAddress]'
GO
CREATE NONCLUSTERED INDEX [FK_StaffInternationalAddress_AddressTypeDescriptor] ON [edfi].[StaffInternationalAddress] ([AddressTypeDescriptorId])
GO
