...
PRINT N'Creating index [FK_EducationOrganization_OperationalStatusDescriptor] on [edfi].[EducationOrganization]'
GO
CREATE NONCLUSTERED INDEX [FK_EducationOrganization_OperationalStatusDescriptor] ON [edfi].[EducationOrganization] ([OperationalStatusDescriptorId])
GO
