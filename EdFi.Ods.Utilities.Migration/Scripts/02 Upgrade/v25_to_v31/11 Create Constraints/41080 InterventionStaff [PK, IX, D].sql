...
GO
ALTER TABLE [edfi].[InterventionStaff] ADD CONSTRAINT [InterventionStaff_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [InterventionIdentificationCode], [StaffUSI])
GO

PRINT N'Creating index [FK_InterventionStaff_Intervention] on [edfi].[InterventionStaff]'
GO
CREATE NONCLUSTERED INDEX [FK_InterventionStaff_Intervention] ON [edfi].[InterventionStaff] ([EducationOrganizationId], [InterventionIdentificationCode])
GO
