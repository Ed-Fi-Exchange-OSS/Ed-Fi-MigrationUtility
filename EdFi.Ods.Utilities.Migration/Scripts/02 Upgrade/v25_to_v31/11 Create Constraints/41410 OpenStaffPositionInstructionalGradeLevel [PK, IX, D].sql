...
GO
ALTER TABLE [edfi].[OpenStaffPositionInstructionalGradeLevel] ADD CONSTRAINT [OpenStaffPositionInstructionalGradeLevel_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [GradeLevelDescriptorId], [RequisitionNumber])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_OpenStaffPositionInstructionalGradeLevel_OpenStaffPosition] ON [edfi].[OpenStaffPositionInstructionalGradeLevel] ([EducationOrganizationId], [RequisitionNumber])
GO
