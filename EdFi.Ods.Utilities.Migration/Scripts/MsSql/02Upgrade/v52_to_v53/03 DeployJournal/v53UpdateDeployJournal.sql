...
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1170-UpdatedAuthViewsToRemoveJoin.sql'),
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1180-Add-OrgDeptId-to-EdOrgIdentifiers.sql'),
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1190-UpdateVersionTo520.sql'),
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1200-AuthViewsSupportOrgDeptId.sql'),
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1290-RemoveAllUnusedAuthorizationViews.sql'),
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1300-CreateEdOrgToEdOrgTable.sql'),
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1302-CreateEdOrgToEdOrgTriggers.sql'),
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1303-AuthViewEducationOrganizationIdToStudentUSI.sql'),
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1304-AuthViewEducationOrganizationIdToParentUSI.sql'),
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1305-AuthViewsEducationOrganizationIdToStaffUSI.sql'),
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1306-AuthViewEducationOrganizationIdToStudentUSIThroughResponsibility.sql'),
('EdFi.Ods.Standard.Artifacts.MsSql.Structure.Ods.1320-UpdateVersionTo53.sql'),
