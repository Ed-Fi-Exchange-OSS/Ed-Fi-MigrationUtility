...
GO
PRINT N'Dropping Default Constraint unnamed constraint on [edfi].[CourseTranscript]...';
...
GO
PRINT N'Creating Extended Property [edfi].[CourseTranscript].[AlternativeCourseCode].[MS_Description]...';
