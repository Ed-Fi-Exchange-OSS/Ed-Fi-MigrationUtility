...
GO
ALTER TABLE [edfi].[PostSecondaryEvent] ADD CONSTRAINT [PostSecondaryEvent_PK] PRIMARY KEY CLUSTERED  ([StudentUSI], [PostSecondaryEventCategoryTypeId], [EventDate])
GO
...
GO
PRINT N'Creating index [FK_PostSecondaryEvent_PostSecondaryEventCategoryType] on [edfi].[PostSecondaryEvent]'
GO
CREATE NONCLUSTERED INDEX [FK_PostSecondaryEvent_PostSecondaryEventCategoryType] ON [edfi].[PostSecondaryEvent] ([PostSecondaryEventCategoryTypeId])
GO
