...
GO
ALTER TABLE [edfi].[StaffSchoolAssociationAcademicSubject] ADD CONSTRAINT [StaffSchoolAssociationAcademicSubject_PK] PRIMARY KEY CLUSTERED  ([StaffUSI], [ProgramAssignmentDescriptorId], [SchoolId], [AcademicSubjectDescriptorId])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_StaffSchoolAssociationAcademicSubject_StaffSchoolAssociation] ON [edfi].[StaffSchoolAssociationAcademicSubject] ([StaffUSI], [ProgramAssignmentDescriptorId], [SchoolId])
GO
