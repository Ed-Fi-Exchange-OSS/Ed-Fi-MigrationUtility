...
GO
ALTER TABLE [edfi].[StudentCharacteristicDescriptor] ADD CONSTRAINT [FK_StudentCharacteristicDescriptor_StudentCharacteristicType] FOREIGN KEY ([StudentCharacteristicTypeId]) REFERENCES [edfi].[StudentCharacteristicType] ([StudentCharacteristicTypeId])
GO
