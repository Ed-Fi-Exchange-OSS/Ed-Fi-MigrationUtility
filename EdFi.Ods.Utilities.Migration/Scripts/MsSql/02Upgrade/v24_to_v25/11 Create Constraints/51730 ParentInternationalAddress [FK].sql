...
GO
ALTER TABLE [edfi].[ParentInternationalAddress] ADD CONSTRAINT [FK_ParentInternationalAddress_AddressType] FOREIGN KEY ([AddressTypeId]) REFERENCES [edfi].[AddressType] ([AddressTypeId])
GO
