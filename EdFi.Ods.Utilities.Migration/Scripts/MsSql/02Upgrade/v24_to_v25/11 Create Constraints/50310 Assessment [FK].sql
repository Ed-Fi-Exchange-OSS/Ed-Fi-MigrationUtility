...
GO
ALTER TABLE [edfi].[Assessment] ADD CONSTRAINT [FK_Assessment_AssessmentFamily] FOREIGN KEY ([AssessmentFamilyTitle]) REFERENCES [edfi].[AssessmentFamily] ([AssessmentFamilyTitle])
GO
ALTER TABLE [edfi].[Assessment] ADD CONSTRAINT [FK_Assessment_AssessmentPeriodDescriptor] FOREIGN KEY ([AssessmentPeriodDescriptorId]) REFERENCES [edfi].[AssessmentPeriodDescriptor] ([AssessmentPeriodDescriptorId])
GO
