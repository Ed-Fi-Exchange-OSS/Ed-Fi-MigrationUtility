...
GO
ALTER TABLE [edfi].[StudentGradebookEntry] ADD CONSTRAINT [StudentGradebookEntry_PK] PRIMARY KEY CLUSTERED  ([StudentUSI], [ClassroomIdentificationCode], [SchoolId], [ClassPeriodName], [LocalCourseCode], [SchoolYear], [TermDescriptorId], [UniqueSectionCode], [SequenceOfCourse], [BeginDate], [GradebookEntryTitle], [DateAssigned])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_StudentGradebookEntry_GradebookEntry] ON [edfi].[StudentGradebookEntry] ([GradebookEntryTitle], [ClassroomIdentificationCode], [SchoolId], [ClassPeriodName], [LocalCourseCode], [SchoolYear], [TermDescriptorId], [UniqueSectionCode], [SequenceOfCourse], [DateAssigned])
GO
PRINT N'Creating index [FK_StudentGradebookEntry_StudentSectionAssociation] on [edfi].[StudentGradebookEntry]'
GO
CREATE NONCLUSTERED INDEX [FK_StudentGradebookEntry_StudentSectionAssociation] ON [edfi].[StudentGradebookEntry] ([StudentUSI], [SchoolId], [ClassPeriodName], [ClassroomIdentificationCode], [LocalCourseCode], [UniqueSectionCode], [SequenceOfCourse], [SchoolYear], [TermDescriptorId], [BeginDate])
GO
