...
GO
ALTER TABLE [edfi].[StateEducationAgencyAccountability] ADD CONSTRAINT [StateEducationAgencyAccountability_PK] PRIMARY KEY CLUSTERED  ([StateEducationAgencyId], [SchoolYear])
GO
