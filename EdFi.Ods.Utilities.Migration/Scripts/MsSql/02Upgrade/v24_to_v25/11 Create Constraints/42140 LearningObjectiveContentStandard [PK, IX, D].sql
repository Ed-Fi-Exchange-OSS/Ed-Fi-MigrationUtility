...
GO
PRINT N'Creating index [FK_LearningObjectiveContentStandard_LearningObjective] on [edfi].[LearningObjectiveContentStandard]'
GO
CREATE NONCLUSTERED INDEX [FK_LearningObjectiveContentStandard_LearningObjective] ON [edfi].[LearningObjectiveContentStandard] ([LearningObjectiveId], [Namespace])
GO
...
GO
PRINT N'Creating index [FK_LearningObjectiveContentStandard_PublicationStatusType] on [edfi].[LearningObjectiveContentStandard]'
GO
CREATE NONCLUSTERED INDEX [FK_LearningObjectiveContentStandard_PublicationStatusType] ON [edfi].[LearningObjectiveContentStandard] ([PublicationStatusTypeId])
GO
