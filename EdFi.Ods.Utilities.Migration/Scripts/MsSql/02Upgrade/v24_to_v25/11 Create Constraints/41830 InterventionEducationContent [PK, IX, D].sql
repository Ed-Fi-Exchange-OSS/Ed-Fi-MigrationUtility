...
GO
ALTER TABLE [edfi].[InterventionEducationContent] ADD CONSTRAINT [InterventionEducationContent_PK] PRIMARY KEY CLUSTERED  ([InterventionIdentificationCode], [EducationOrganizationId], [ContentIdentifier])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_InterventionEducationContent_Intervention] ON [edfi].[InterventionEducationContent] ([InterventionIdentificationCode], [EducationOrganizationId])
GO
