...
GO
ALTER TABLE [edfi].[ClassroomPositionDescriptor] ADD CONSTRAINT [FK_ClassroomPositionDescriptor_ClassroomPositionType] FOREIGN KEY ([ClassroomPositionTypeId]) REFERENCES [edfi].[ClassroomPositionType] ([ClassroomPositionTypeId])
GO
