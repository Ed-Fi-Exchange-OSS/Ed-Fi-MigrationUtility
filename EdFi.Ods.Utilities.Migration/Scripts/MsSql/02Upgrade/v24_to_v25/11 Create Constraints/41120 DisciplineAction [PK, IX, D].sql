...
GO
ALTER TABLE [edfi].[DisciplineAction] ADD CONSTRAINT [DisciplineAction_PK] PRIMARY KEY CLUSTERED  ([DisciplineActionIdentifier], [StudentUSI], [DisciplineDate])
GO
...
GO
PRINT N'Creating index [FK_DisciplineAction_DisciplineActionLengthDifferenceReasonType] on [edfi].[DisciplineAction]'
GO
CREATE NONCLUSTERED INDEX [FK_DisciplineAction_DisciplineActionLengthDifferenceReasonType] ON [edfi].[DisciplineAction] ([DisciplineActionLengthDifferenceReasonTypeId])
GO
