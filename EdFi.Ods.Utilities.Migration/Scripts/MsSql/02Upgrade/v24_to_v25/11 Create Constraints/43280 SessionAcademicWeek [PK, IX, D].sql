...
GO
ALTER TABLE [edfi].[SessionAcademicWeek] ADD CONSTRAINT [SessionAcademicWeek_PK] PRIMARY KEY CLUSTERED  ([SchoolId], [WeekIdentifier], [SchoolYear], [TermDescriptorId])
GO
PRINT N'Creating index [FK_SessionAcademicWeek_Session] on [edfi].[SessionAcademicWeek]'
GO
CREATE NONCLUSTERED INDEX [FK_SessionAcademicWeek_Session] ON [edfi].[SessionAcademicWeek] ([SchoolId], [SchoolYear], [TermDescriptorId])
GO
PRINT N'Creating index [FK_SessionAcademicWeek_AcademicWeek] on [edfi].[SessionAcademicWeek]'
GO
CREATE NONCLUSTERED INDEX [FK_SessionAcademicWeek_AcademicWeek] ON [edfi].[SessionAcademicWeek] ([WeekIdentifier], [SchoolId])
GO
