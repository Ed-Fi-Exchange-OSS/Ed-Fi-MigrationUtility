...
GO
ALTER TABLE [edfi].[StaffClassificationDescriptor] ADD CONSTRAINT [FK_StaffClassificationDescriptor_StaffClassificationType] FOREIGN KEY ([StaffClassificationTypeId]) REFERENCES [edfi].[StaffClassificationType] ([StaffClassificationTypeId])
GO
