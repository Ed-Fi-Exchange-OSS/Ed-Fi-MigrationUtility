...
GO
ALTER TABLE [edfi].[BehaviorDescriptor] ADD CONSTRAINT [FK_BehaviorDescriptor_BehaviorType] FOREIGN KEY ([BehaviorTypeId]) REFERENCES [edfi].[BehaviorType] ([BehaviorTypeId])
GO
