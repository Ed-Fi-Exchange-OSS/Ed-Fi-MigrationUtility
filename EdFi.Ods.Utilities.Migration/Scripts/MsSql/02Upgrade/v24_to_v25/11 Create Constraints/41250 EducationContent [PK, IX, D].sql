...
GO
PRINT N'Creating index [FK_EducationContent_ContentClassType] on [edfi].[EducationContent]'
GO
CREATE NONCLUSTERED INDEX [FK_EducationContent_ContentClassType] ON [edfi].[EducationContent] ([ContentClassTypeId])
GO
PRINT N'Creating index [FK_EducationContent_CostRateType] on [edfi].[EducationContent]'
GO
CREATE NONCLUSTERED INDEX [FK_EducationContent_CostRateType] ON [edfi].[EducationContent] ([CostRateTypeId])
GO
PRINT N'Creating index [FK_EducationContent_InteractivityStyleType] on [edfi].[EducationContent]'
GO
CREATE NONCLUSTERED INDEX [FK_EducationContent_InteractivityStyleType] ON [edfi].[EducationContent] ([InteractivityStyleTypeId])
GO
