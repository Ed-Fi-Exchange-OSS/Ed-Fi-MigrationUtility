...
GO
ALTER TABLE [edfi].[InterventionPrescriptionDiagnosis] ADD CONSTRAINT [InterventionPrescriptionDiagnosis_PK] PRIMARY KEY CLUSTERED  ([InterventionPrescriptionIdentificationCode], [EducationOrganizationId], [DiagnosisDescriptorId])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_InterventionPrescriptionDiagnosis_InterventionPrescription] ON [edfi].[InterventionPrescriptionDiagnosis] ([InterventionPrescriptionIdentificationCode], [EducationOrganizationId])
GO
