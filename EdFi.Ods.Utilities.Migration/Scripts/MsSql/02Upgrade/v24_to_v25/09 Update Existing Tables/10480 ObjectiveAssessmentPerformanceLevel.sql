...
PRINT N'Updating Assessment key references in [edfi].[ObjectiveAssessmentPerformanceLevel]'
GO
...
FROM [edfi].[ObjectiveAssessmentPerformanceLevel] a
...
ALTER TABLE [edfi].[ObjectiveAssessmentPerformanceLevel] DROP
