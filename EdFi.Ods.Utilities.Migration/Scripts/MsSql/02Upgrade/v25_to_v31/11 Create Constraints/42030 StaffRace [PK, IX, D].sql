...
GO
ALTER TABLE [edfi].[StaffRace] ADD CONSTRAINT [StaffRace_PK] PRIMARY KEY CLUSTERED  ([RaceDescriptorId], [StaffUSI])
GO

PRINT N'Creating index [FK_StaffRace_RaceDescriptor] on [edfi].[StaffRace]'
GO
CREATE NONCLUSTERED INDEX [FK_StaffRace_RaceDescriptor] ON [edfi].[StaffRace] ([RaceDescriptorId])
GO
