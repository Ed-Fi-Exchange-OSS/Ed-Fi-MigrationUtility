...
GO
ALTER TABLE [edfi].[GraduationPlan] ADD CONSTRAINT [GraduationPlan_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [GraduationPlanTypeDescriptorId], [GraduationSchoolYear])
GO
...
PRINT N'Creating index [FK_GraduationPlan_CreditTypeDescriptor] on [edfi].[GraduationPlan]'
GO
CREATE NONCLUSTERED INDEX [FK_GraduationPlan_CreditTypeDescriptor] ON [edfi].[GraduationPlan] ([TotalRequiredCreditTypeDescriptorId])
GO
