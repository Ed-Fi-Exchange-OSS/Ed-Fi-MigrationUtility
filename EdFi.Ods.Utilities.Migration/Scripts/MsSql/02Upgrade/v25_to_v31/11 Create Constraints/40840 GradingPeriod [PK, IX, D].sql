...
GO
ALTER TABLE [edfi].[GradingPeriod] ADD CONSTRAINT [GradingPeriod_PK] PRIMARY KEY CLUSTERED  ([GradingPeriodDescriptorId], [PeriodSequence], [SchoolId], [SchoolYear])
GO
...
PRINT N'Creating index [FK_GradingPeriod_SchoolYearType] on [edfi].[GradingPeriod]'
GO
CREATE NONCLUSTERED INDEX [FK_GradingPeriod_SchoolYearType] ON [edfi].[GradingPeriod] ([SchoolYear])
GO
