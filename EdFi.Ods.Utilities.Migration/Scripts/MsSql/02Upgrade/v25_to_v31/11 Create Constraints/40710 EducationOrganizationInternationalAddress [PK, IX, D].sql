...
GO
ALTER TABLE [edfi].[EducationOrganizationInternationalAddress] ADD CONSTRAINT [EducationOrganizationInternationalAddress_PK] PRIMARY KEY CLUSTERED  ([AddressTypeDescriptorId], [EducationOrganizationId])
GO

PRINT N'Creating index [FK_EducationOrganizationInternationalAddress_AddressTypeDescriptor] on [edfi].[EducationOrganizationInternationalAddress]'
GO
CREATE NONCLUSTERED INDEX [FK_EducationOrganizationInternationalAddress_AddressTypeDescriptor] ON [edfi].[EducationOrganizationInternationalAddress] ([AddressTypeDescriptorId])
GO
