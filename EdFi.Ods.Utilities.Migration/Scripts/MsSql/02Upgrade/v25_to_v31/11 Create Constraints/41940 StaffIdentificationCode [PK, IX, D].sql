...
GO
ALTER TABLE [edfi].[StaffIdentificationCode] ADD CONSTRAINT [StaffIdentificationCode_PK] PRIMARY KEY CLUSTERED  ([StaffIdentificationSystemDescriptorId], [StaffUSI])
GO
