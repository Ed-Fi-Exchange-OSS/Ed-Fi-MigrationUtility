...
GO
ALTER TABLE [edfi].[InterventionStudyAppropriateGradeLevel] ADD CONSTRAINT [InterventionStudyAppropriateGradeLevel_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [GradeLevelDescriptorId], [InterventionStudyIdentificationCode])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_InterventionStudyAppropriateGradeLevel_InterventionStudy] ON [edfi].[InterventionStudyAppropriateGradeLevel] ([EducationOrganizationId], [InterventionStudyIdentificationCode])
GO
