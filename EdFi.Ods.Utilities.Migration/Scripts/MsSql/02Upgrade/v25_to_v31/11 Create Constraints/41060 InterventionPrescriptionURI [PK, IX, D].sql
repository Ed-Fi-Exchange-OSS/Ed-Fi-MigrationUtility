...
GO
ALTER TABLE [edfi].[InterventionPrescriptionURI] ADD CONSTRAINT [InterventionPrescriptionURI_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [InterventionPrescriptionIdentificationCode], [URI])
GO

PRINT N'Creating index [FK_InterventionPrescriptionURI_InterventionPrescription] on [edfi].[InterventionPrescriptionURI]'
GO
CREATE NONCLUSTERED INDEX [FK_InterventionPrescriptionURI_InterventionPrescription] ON [edfi].[InterventionPrescriptionURI] ([EducationOrganizationId], [InterventionPrescriptionIdentificationCode])
GO
