...
GO
ALTER TABLE [edfi].[Budget] ADD CONSTRAINT [Budget_PK] PRIMARY KEY CLUSTERED  ([AccountIdentifier], [AsOfDate], [EducationOrganizationId], [FiscalYear])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_Budget_Account] ON [edfi].[Budget] ([AccountIdentifier], [EducationOrganizationId], [FiscalYear])
GO
