...
GO
ALTER TABLE [edfi].[CourseOfferedGradeLevel] ADD CONSTRAINT [CourseOfferedGradeLevel_PK] PRIMARY KEY CLUSTERED  ([CourseCode], [EducationOrganizationId], [GradeLevelDescriptorId])
GO

PRINT N'Creating index [FK_CourseOfferedGradeLevel_Course] on [edfi].[CourseOfferedGradeLevel]'
GO
CREATE NONCLUSTERED INDEX [FK_CourseOfferedGradeLevel_Course] ON [edfi].[CourseOfferedGradeLevel] ([CourseCode], [EducationOrganizationId])
GO
