...
GO
ALTER TABLE [edfi].[ProgramService] ADD CONSTRAINT [ProgramService_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId], [ServiceDescriptorId])
GO

PRINT N'Creating index [FK_ProgramService_Program] on [edfi].[ProgramService]'
GO
CREATE NONCLUSTERED INDEX [FK_ProgramService_Program] ON [edfi].[ProgramService] ([EducationOrganizationId], [ProgramName], [ProgramTypeDescriptorId])
GO
