...
GO
ALTER TABLE [edfi].[CourseIdentificationCode] ADD CONSTRAINT [CourseIdentificationCode_PK] PRIMARY KEY CLUSTERED  ([CourseCode], [CourseIdentificationSystemDescriptorId], [EducationOrganizationId])
GO

PRINT N'Creating index [FK_CourseIdentificationCode_Course] on [edfi].[CourseIdentificationCode]'
GO
CREATE NONCLUSTERED INDEX [FK_CourseIdentificationCode_Course] ON [edfi].[CourseIdentificationCode] ([CourseCode], [EducationOrganizationId])
GO
