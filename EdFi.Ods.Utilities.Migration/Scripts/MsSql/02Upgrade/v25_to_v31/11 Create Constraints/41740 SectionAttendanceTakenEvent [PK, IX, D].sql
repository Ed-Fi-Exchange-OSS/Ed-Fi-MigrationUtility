...
GO
ALTER TABLE [edfi].[SectionAttendanceTakenEvent] ADD CONSTRAINT [SectionAttendanceTakenEvent_PK] PRIMARY KEY CLUSTERED  ([CalendarCode], [Date], [LocalCourseCode], [SchoolId], [SchoolYear], [SectionIdentifier], [SessionName])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_SectionAttendanceTakenEvent_CalendarDate] ON [edfi].[SectionAttendanceTakenEvent] ([CalendarCode], [Date], [SchoolId], [SchoolYear])
GO

PRINT N'Creating index [FK_SectionAttendanceTakenEvent_Section] on [edfi].[SectionAttendanceTakenEvent]'
GO
CREATE NONCLUSTERED INDEX [FK_SectionAttendanceTakenEvent_Section] ON [edfi].[SectionAttendanceTakenEvent] ([LocalCourseCode], [SchoolId], [SchoolYear], [SectionIdentifier], [SessionName])
GO
