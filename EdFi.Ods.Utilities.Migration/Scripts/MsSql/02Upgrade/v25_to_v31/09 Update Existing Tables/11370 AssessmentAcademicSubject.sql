...
PRINT N'Converting namespace to v3 format on [edfi].[AssessmentAcademicSubject]'
GO

UPDATE [edfi].[AssessmentAcademicSubject]
SET
	[AssessmentIdentifier] = m.[V3AssessmentIdentifier],
	[Namespace] = m.[V3Namespace]
FROM [migration_tempdata].[AssessmentIdentityMapping] m
INNER JOIN [edfi].[AssessmentAcademicSubject] a
