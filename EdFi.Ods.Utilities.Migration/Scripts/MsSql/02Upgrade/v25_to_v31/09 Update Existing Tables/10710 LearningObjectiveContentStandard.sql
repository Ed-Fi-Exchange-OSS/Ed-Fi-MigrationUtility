...
PRINT N'Converting namespace to v3 format on [edfi].[LearningObjectiveContentStandard]'
GO

UPDATE [edfi].[LearningObjectiveContentStandard]
SET
...
INNER JOIN [edfi].[LearningObjectiveContentStandard] l
	ON l.[LearningObjectiveId] = m.[V2LearningObjectiveId]
	AND l.[Namespace] = m.[V2Namespace]
GO

PRINT N'Converting type to descriptor on [edfi].[LearningObjectiveContentStandard]'
GO

EXEC [migration_tempdata].[sp_ConvertTypeToDescriptor]
'edfi', 'LearningObjectiveContentStandard',
