...
PRINT N'Updating Assessment key references in [edfi].[StudentAssessmentStudentObjectiveAssessment]'
GO
...
FROM [edfi].[StudentAssessmentStudentObjectiveAssessment] a
...
ALTER TABLE [edfi].[StudentAssessmentStudentObjectiveAssessment] DROP
