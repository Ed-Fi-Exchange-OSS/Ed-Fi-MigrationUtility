...
PRINT N'Updating LearningObjective key references in [edfi].[ReportCardStudentLearningObjective]'
GO
...
FROM [edfi].[ReportCardStudentLearningObjective] o
...
ALTER TABLE [edfi].[ReportCardStudentLearningObjective] DROP
	COLUMN [Objective],
