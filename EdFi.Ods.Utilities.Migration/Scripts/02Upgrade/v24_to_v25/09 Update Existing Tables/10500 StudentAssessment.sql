...
PRINT N'Updating Assessment key references in [edfi].[StudentAssessment]'
GO
...
ALTER TABLE [edfi].[StudentAssessment] ALTER COLUMN [AdministrationDate] [datetime2] NOT NULL
GO

ALTER TABLE [edfi].[StudentAssessment] ALTER COLUMN [AdministrationEndDate] [datetime2] NULL
GO

ALTER TABLE [edfi].[StudentAssessment] DROP
