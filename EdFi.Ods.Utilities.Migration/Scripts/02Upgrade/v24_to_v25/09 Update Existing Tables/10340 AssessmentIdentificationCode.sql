...
PRINT N'Updating Assessment key references in [edfi].[AssessmentIdentificationCode]'
GO
...
FROM [edfi].[AssessmentIdentificationCode] a
...
ALTER TABLE [edfi].[AssessmentIdentificationCode] DROP
