...
PRINT N'Updating Assessment key references in [edfi].[GraduationPlanRequiredAssessmentAssessmentPerformanceLevel]'
GO
...
UPDATE [edfi].[GraduationPlanRequiredAssessmentAssessmentPerformanceLevel]
SET
	[AssessmentIdentifier] = m.[AssessmentIdentifier],
	[Namespace] = m.[Namespace]
FROM [edfi].[GraduationPlanRequiredAssessmentAssessmentPerformanceLevel] a
...
ALTER TABLE [edfi].[GraduationPlanRequiredAssessmentAssessmentPerformanceLevel] DROP
