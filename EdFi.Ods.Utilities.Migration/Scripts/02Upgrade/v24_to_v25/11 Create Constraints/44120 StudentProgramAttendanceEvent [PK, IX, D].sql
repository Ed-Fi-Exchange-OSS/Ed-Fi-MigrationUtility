...
GO
ALTER TABLE [edfi].[StudentProgramAttendanceEvent] ADD CONSTRAINT [StudentProgramAttendanceEvent_PK] PRIMARY KEY CLUSTERED  ([StudentUSI], [ProgramEducationOrganizationId], [ProgramTypeId], [EventDate], [AttendanceEventCategoryDescriptorId], [ProgramName], [EducationOrganizationId])
GO
...
GO
PRINT N'Creating index [FK_StudentProgramAttendanceEvent_EducationalEnvironmentType] on [edfi].[StudentProgramAttendanceEvent]'
GO
CREATE NONCLUSTERED INDEX [FK_StudentProgramAttendanceEvent_EducationalEnvironmentType] ON [edfi].[StudentProgramAttendanceEvent] ([EducationalEnvironmentTypeId])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_StudentProgramAttendanceEvent_Program] ON [edfi].[StudentProgramAttendanceEvent] ([ProgramEducationOrganizationId], [ProgramTypeId], [ProgramName])
GO
