...
GO
ALTER TABLE [edfi].[AchievementCategoryDescriptor] ADD CONSTRAINT [FK_AchievementCategoryDescriptor_AchievementCategoryType] FOREIGN KEY ([AchievementCategoryTypeId]) REFERENCES [edfi].[AchievementCategoryType] ([AchievementCategoryTypeId])
GO
