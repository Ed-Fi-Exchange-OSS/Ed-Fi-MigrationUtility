...
GO
ALTER TABLE [edfi].[StudentInterventionAttendanceEvent] ADD CONSTRAINT [StudentInterventionAttendanceEvent_PK] PRIMARY KEY CLUSTERED  ([StudentUSI], [InterventionIdentificationCode], [EducationOrganizationId], [EventDate], [AttendanceEventCategoryDescriptorId])
GO
...
GO
PRINT N'Creating index [FK_StudentInterventionAttendanceEvent_EducationalEnvironmentType] on [edfi].[StudentInterventionAttendanceEvent]'
GO
CREATE NONCLUSTERED INDEX [FK_StudentInterventionAttendanceEvent_EducationalEnvironmentType] ON [edfi].[StudentInterventionAttendanceEvent] ([EducationalEnvironmentTypeId])
GO
PRINT N'Creating index [FK_StudentInterventionAttendanceEvent_Intervention] on [edfi].[StudentInterventionAttendanceEvent]'
GO
CREATE NONCLUSTERED INDEX [FK_StudentInterventionAttendanceEvent_Intervention] ON [edfi].[StudentInterventionAttendanceEvent] ([InterventionIdentificationCode], [EducationOrganizationId])
GO
