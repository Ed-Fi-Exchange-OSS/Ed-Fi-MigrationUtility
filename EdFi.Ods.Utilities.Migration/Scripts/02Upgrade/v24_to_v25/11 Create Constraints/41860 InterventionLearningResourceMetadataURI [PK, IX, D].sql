...
GO
ALTER TABLE [edfi].[InterventionLearningResourceMetadataURI] ADD CONSTRAINT [InterventionLearningResourceMetadataURI_PK] PRIMARY KEY CLUSTERED  ([InterventionIdentificationCode], [EducationOrganizationId], [LearningResourceMetadataURI])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_InterventionLearningResourceMetadataURI_Intervention] ON [edfi].[InterventionLearningResourceMetadataURI] ([InterventionIdentificationCode], [EducationOrganizationId])
GO
