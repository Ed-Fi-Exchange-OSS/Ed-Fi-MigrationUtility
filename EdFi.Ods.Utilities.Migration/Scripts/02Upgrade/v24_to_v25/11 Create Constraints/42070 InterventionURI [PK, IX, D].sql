...
GO
ALTER TABLE [edfi].[InterventionURI] ADD CONSTRAINT [InterventionURI_PK] PRIMARY KEY CLUSTERED  ([InterventionIdentificationCode], [EducationOrganizationId], [URI])
GO
PRINT N'Creating index [FK_InterventionURI_Intervention] on [edfi].[InterventionURI]'
GO
CREATE NONCLUSTERED INDEX [FK_InterventionURI_Intervention] ON [edfi].[InterventionURI] ([InterventionIdentificationCode], [EducationOrganizationId])
GO
