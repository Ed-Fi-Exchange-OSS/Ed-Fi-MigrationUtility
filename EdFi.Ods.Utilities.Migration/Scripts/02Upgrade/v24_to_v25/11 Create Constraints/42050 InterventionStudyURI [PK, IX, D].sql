...
GO
ALTER TABLE [edfi].[InterventionStudyURI] ADD CONSTRAINT [InterventionStudyURI_PK] PRIMARY KEY CLUSTERED  ([InterventionStudyIdentificationCode], [EducationOrganizationId], [URI])
GO
PRINT N'Creating index [FK_InterventionStudyURI_InterventionStudy] on [edfi].[InterventionStudyURI]'
GO
CREATE NONCLUSTERED INDEX [FK_InterventionStudyURI_InterventionStudy] ON [edfi].[InterventionStudyURI] ([InterventionStudyIdentificationCode], [EducationOrganizationId])
GO
