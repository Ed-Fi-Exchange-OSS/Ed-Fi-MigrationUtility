...
GO
ALTER TABLE [edfi].[EducationOrganizationNetworkAssociation] ADD CONSTRAINT [EducationOrganizationNetworkAssociation_PK] PRIMARY KEY CLUSTERED  ([MemberEducationOrganizationId], [EducationOrganizationNetworkId])
GO
