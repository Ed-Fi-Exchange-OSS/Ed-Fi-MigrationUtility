...
GO
ALTER TABLE [edfi].[ResponsibilityDescriptor] ADD CONSTRAINT [FK_ResponsibilityDescriptor_ResponsibilityType] FOREIGN KEY ([ResponsibilityTypeId]) REFERENCES [edfi].[ResponsibilityType] ([ResponsibilityTypeId])
GO
