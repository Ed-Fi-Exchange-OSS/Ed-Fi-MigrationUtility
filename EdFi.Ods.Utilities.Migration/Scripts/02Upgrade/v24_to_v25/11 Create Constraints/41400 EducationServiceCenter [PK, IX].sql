...
GO
PRINT N'Creating index [FK_EducationServiceCenter_EducationOrganization] on [edfi].[EducationServiceCenter]'
GO
CREATE NONCLUSTERED INDEX [FK_EducationServiceCenter_EducationOrganization] ON [edfi].[EducationServiceCenter] ([EducationServiceCenterId])
GO
