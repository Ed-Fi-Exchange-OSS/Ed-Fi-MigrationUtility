...
GO
ALTER TABLE [edfi].[CourseOfferedGradeLevel] ADD CONSTRAINT [FK_CourseOfferedGradeLevel_Course] FOREIGN KEY ([EducationOrganizationId], [CourseCode]) REFERENCES [edfi].[Course] ([EducationOrganizationId], [CourseCode]) ON DELETE CASCADE
GO
