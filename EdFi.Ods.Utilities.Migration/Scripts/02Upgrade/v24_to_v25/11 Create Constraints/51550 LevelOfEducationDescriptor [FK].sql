...
GO
ALTER TABLE [edfi].[LevelOfEducationDescriptor] ADD CONSTRAINT [FK_LevelOfEducationDescriptor_LevelOfEducationType] FOREIGN KEY ([LevelOfEducationTypeId]) REFERENCES [edfi].[LevelOfEducationType] ([LevelOfEducationTypeId])
GO
