...
GO
ALTER TABLE [edfi].[InterventionStudyEducationContent] ADD CONSTRAINT [InterventionStudyEducationContent_PK] PRIMARY KEY CLUSTERED  ([InterventionStudyIdentificationCode], [EducationOrganizationId], [ContentIdentifier])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_InterventionStudyEducationContent_InterventionStudy] ON [edfi].[InterventionStudyEducationContent] ([InterventionStudyIdentificationCode], [EducationOrganizationId])
GO
