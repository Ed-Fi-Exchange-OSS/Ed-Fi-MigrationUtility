...
GO
ALTER TABLE [edfi].[SectionCharacteristic] ADD CONSTRAINT [SectionCharacteristic_PK] PRIMARY KEY CLUSTERED  ([SectionCharacteristicDescriptorId], [ClassroomIdentificationCode], [SchoolId], [ClassPeriodName], [LocalCourseCode], [SchoolYear], [TermDescriptorId], [UniqueSectionCode], [SequenceOfCourse])
GO
PRINT N'Creating index [FK_SectionCharacteristic_Section] on [edfi].[SectionCharacteristic]'
GO
CREATE NONCLUSTERED INDEX [FK_SectionCharacteristic_Section] ON [edfi].[SectionCharacteristic] ([SchoolId], [ClassPeriodName], [ClassroomIdentificationCode], [LocalCourseCode], [TermDescriptorId], [SchoolYear], [UniqueSectionCode], [SequenceOfCourse])
GO
