...
GO
ALTER TABLE [edfi].[LearningStandardIdentificationCode] ADD CONSTRAINT [LearningStandardIdentificationCode_PK] PRIMARY KEY CLUSTERED  ([LearningStandardId], [IdentificationCode], [ContentStandardName])
GO
