...
GO
PRINT N'Creating index [FK_AssessmentItem_AssessmentItemCategoryType] on [edfi].[AssessmentItem]'
GO
CREATE NONCLUSTERED INDEX [FK_AssessmentItem_AssessmentItemCategoryType] ON [edfi].[AssessmentItem] ([AssessmentItemCategoryTypeId])
GO
