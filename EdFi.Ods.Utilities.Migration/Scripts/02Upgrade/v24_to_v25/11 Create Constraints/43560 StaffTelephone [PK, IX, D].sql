...
GO
ALTER TABLE [edfi].[StaffTelephone] ADD CONSTRAINT [StaffTelephone_PK] PRIMARY KEY CLUSTERED  ([StaffUSI], [TelephoneNumberTypeId])
GO
...
GO
PRINT N'Creating index [FK_StaffTelephone_TelephoneNumberType] on [edfi].[StaffTelephone]'
GO
CREATE NONCLUSTERED INDEX [FK_StaffTelephone_TelephoneNumberType] ON [edfi].[StaffTelephone] ([TelephoneNumberTypeId])
GO
