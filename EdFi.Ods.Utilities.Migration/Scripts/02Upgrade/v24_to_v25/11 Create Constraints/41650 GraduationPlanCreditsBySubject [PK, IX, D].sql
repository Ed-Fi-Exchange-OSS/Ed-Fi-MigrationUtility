...
GO
ALTER TABLE [edfi].[GraduationPlanCreditsBySubject] ADD CONSTRAINT [GraduationPlanCreditsBySubject_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [AcademicSubjectDescriptorId], [GraduationPlanTypeDescriptorId], [GraduationSchoolYear])
GO
...
GO
PRINT N'Creating index [FK_GraduationPlanCreditsBySubject_CreditType] on [edfi].[GraduationPlanCreditsBySubject]'
GO
CREATE NONCLUSTERED INDEX [FK_GraduationPlanCreditsBySubject_CreditType] ON [edfi].[GraduationPlanCreditsBySubject] ([CreditTypeId])
GO
PRINT N'Creating index [FK_GraduationPlanCreditsBySubject_GraduationPlan] on [edfi].[GraduationPlanCreditsBySubject]'
GO
CREATE NONCLUSTERED INDEX [FK_GraduationPlanCreditsBySubject_GraduationPlan] ON [edfi].[GraduationPlanCreditsBySubject] ([GraduationPlanTypeDescriptorId], [EducationOrganizationId], [GraduationSchoolYear])
GO
