...
GO
ALTER TABLE [edfi].[OpenStaffPositionAcademicSubject] ADD CONSTRAINT [OpenStaffPositionAcademicSubject_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [StaffClassificationDescriptorId], [RequisitionNumber], [DatePosted], [AcademicSubjectDescriptorId], [EmploymentStatusDescriptorId])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_OpenStaffPositionAcademicSubject_OpenStaffPosition] ON [edfi].[OpenStaffPositionAcademicSubject] ([EducationOrganizationId], [EmploymentStatusDescriptorId], [StaffClassificationDescriptorId], [RequisitionNumber], [DatePosted])
GO
