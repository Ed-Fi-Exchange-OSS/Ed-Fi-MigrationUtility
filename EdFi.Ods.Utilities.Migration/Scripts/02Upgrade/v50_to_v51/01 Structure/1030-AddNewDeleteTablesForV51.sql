...
CREATE TABLE [tracked_deletes_edfi].[AbsenceEventCategoryDescriptor] (
    ...
    CONSTRAINT [PK_AbsenceEventCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AcademicHonorCategoryDescriptor] (
    ...
    [Id]                                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                     BIGINT           NOT NULL,
    CONSTRAINT [PK_AcademicHonorCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AcademicSubjectDescriptor] (
    ...
    [Id]                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]               BIGINT           NOT NULL,
    CONSTRAINT [PK_AcademicSubjectDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AcademicWeek] (
    ...
    [Id]             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]  BIGINT           NOT NULL,
    CONSTRAINT [PK_AcademicWeek] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AccommodationDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_AccommodationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Account] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_Account] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AccountabilityRating] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_AccountabilityRating] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AccountClassificationDescriptor] (
    ...
    [Id]                                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                     BIGINT           NOT NULL,
    CONSTRAINT [PK_AccountClassificationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AccountCode] (
    ...
    [Id]                                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                     BIGINT           NOT NULL,
    CONSTRAINT [PK_AccountCode] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AchievementCategoryDescriptor] (
    ...
    [Id]                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                   BIGINT           NOT NULL,
    CONSTRAINT [PK_AchievementCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Actual] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_Actual] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AdditionalCreditTypeDescriptor] (
    ...
    [Id]                               UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                    BIGINT           NOT NULL,
    CONSTRAINT [PK_AdditionalCreditTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AddressTypeDescriptor] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_AddressTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AdministrationEnvironmentDescriptor] (
    ...
    [Id]                                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                         BIGINT           NOT NULL,
    CONSTRAINT [PK_AdministrationEnvironmentDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AdministrativeFundingControlDescriptor] (
    ...
    [Id]                                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                            BIGINT           NOT NULL,
    CONSTRAINT [PK_AdministrativeFundingControlDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Assessment] (
    ...
    [Id]                   UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]        BIGINT           NOT NULL,
    CONSTRAINT [PK_Assessment] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AssessmentCategoryDescriptor] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_AssessmentCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AssessmentIdentificationSystemDescriptor] (
    ...
    [Id]                                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                              BIGINT           NOT NULL,
    CONSTRAINT [PK_AssessmentIdentificationSystemDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AssessmentItem] (
    ...
    [Id]                   UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]        BIGINT           NOT NULL,
    CONSTRAINT [PK_AssessmentItem] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AssessmentItemCategoryDescriptor] (
    ...
    [Id]                                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                      BIGINT           NOT NULL,
    CONSTRAINT [PK_AssessmentItemCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AssessmentItemResultDescriptor] (
    ...
    [Id]                               UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                    BIGINT           NOT NULL,
    CONSTRAINT [PK_AssessmentItemResultDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AssessmentPeriodDescriptor] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_AssessmentPeriodDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AssessmentReportingMethodDescriptor] (
    ...
    [Id]                                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                         BIGINT           NOT NULL,
    CONSTRAINT [PK_AssessmentReportingMethodDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AttemptStatusDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_AttemptStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[AttendanceEventCategoryDescriptor] (
    ...
    [Id]                                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                       BIGINT           NOT NULL,
    CONSTRAINT [PK_AttendanceEventCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[BehaviorDescriptor] (
    ...
    [Id]                   UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]        BIGINT           NOT NULL,
    CONSTRAINT [PK_BehaviorDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[BellSchedule] (
    ...
    [Id]               UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]    BIGINT           NOT NULL,
    CONSTRAINT [PK_BellSchedule] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Budget] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_Budget] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Calendar] (
    ...
    [Id]            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion] BIGINT           NOT NULL,
    CONSTRAINT [PK_Calendar] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CalendarDate] (
    ...
    [Id]            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion] BIGINT           NOT NULL,
    CONSTRAINT [PK_CalendarDate] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CalendarEventDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_CalendarEventDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CalendarTypeDescriptor] (
    ...
    [Id]                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]            BIGINT           NOT NULL,
    CONSTRAINT [PK_CalendarTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CareerPathwayDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_CareerPathwayDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CharterApprovalAgencyTypeDescriptor] (
    ...
    [Id]                                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                         BIGINT           NOT NULL,
    CONSTRAINT [PK_CharterApprovalAgencyTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CharterStatusDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_CharterStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CitizenshipStatusDescriptor] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_CitizenshipStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ClassPeriod] (
    ...
    [Id]              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]   BIGINT           NOT NULL,
    CONSTRAINT [PK_ClassPeriod] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ClassroomPositionDescriptor] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_ClassroomPositionDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Cohort] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_Cohort] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CohortScopeDescriptor] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_CohortScopeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CohortTypeDescriptor] (
    ...
    [Id]                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]          BIGINT           NOT NULL,
    CONSTRAINT [PK_CohortTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CohortYearTypeDescriptor] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_CohortYearTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CommunityOrganization] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_CommunityOrganization] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CommunityProvider] (
    ...
    [Id]                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]       BIGINT           NOT NULL,
    CONSTRAINT [PK_CommunityProvider] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CommunityProviderLicense] (
    ...
    [Id]                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]         BIGINT           NOT NULL,
    CONSTRAINT [PK_CommunityProviderLicense] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CompetencyLevelDescriptor] (
    ...
    [Id]                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]               BIGINT           NOT NULL,
    CONSTRAINT [PK_CompetencyLevelDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CompetencyObjective] (
    ...
    [Id]                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                   BIGINT           NOT NULL,
    CONSTRAINT [PK_CompetencyObjective] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ContactTypeDescriptor] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_ContactTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ContentClassDescriptor] (
    ...
    [Id]                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]            BIGINT           NOT NULL,
    CONSTRAINT [PK_ContentClassDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ContinuationOfServicesReasonDescriptor] (
    ...
    [Id]                                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                            BIGINT           NOT NULL,
    CONSTRAINT [PK_ContinuationOfServicesReasonDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ContractedStaff] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_ContractedStaff] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CostRateDescriptor] (
    ...
    [Id]                   UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]        BIGINT           NOT NULL,
    CONSTRAINT [PK_CostRateDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CountryDescriptor] (
    ...
    [Id]                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]       BIGINT           NOT NULL,
    CONSTRAINT [PK_CountryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Course] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_Course] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CourseAttemptResultDescriptor] (
    ...
    [Id]                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                   BIGINT           NOT NULL,
    CONSTRAINT [PK_CourseAttemptResultDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CourseDefinedByDescriptor] (
    ...
    [Id]                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]               BIGINT           NOT NULL,
    CONSTRAINT [PK_CourseDefinedByDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CourseGPAApplicabilityDescriptor] (
    ...
    [Id]                                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                      BIGINT           NOT NULL,
    CONSTRAINT [PK_CourseGPAApplicabilityDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CourseIdentificationSystemDescriptor] (
    ...
    [Id]                                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                          BIGINT           NOT NULL,
    CONSTRAINT [PK_CourseIdentificationSystemDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CourseLevelCharacteristicDescriptor] (
    ...
    [Id]                                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                         BIGINT           NOT NULL,
    CONSTRAINT [PK_CourseLevelCharacteristicDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CourseOffering] (
    ...
    [Id]              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]   BIGINT           NOT NULL,
    CONSTRAINT [PK_CourseOffering] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CourseRepeatCodeDescriptor] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_CourseRepeatCodeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CourseTranscript] (
    ...
    [Id]                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                   BIGINT           NOT NULL,
    CONSTRAINT [PK_CourseTranscript] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Credential] (
    ...
    [Id]                                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                             BIGINT           NOT NULL,
    CONSTRAINT [PK_Credential] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CredentialFieldDescriptor] (
    ...
    [Id]                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]               BIGINT           NOT NULL,
    CONSTRAINT [PK_CredentialFieldDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CredentialTypeDescriptor] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_CredentialTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CreditCategoryDescriptor] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_CreditCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CreditTypeDescriptor] (
    ...
    [Id]                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]          BIGINT           NOT NULL,
    CONSTRAINT [PK_CreditTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CTEProgramServiceDescriptor] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_CTEProgramServiceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[CurriculumUsedDescriptor] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_CurriculumUsedDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DeliveryMethodDescriptor] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_DeliveryMethodDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Descriptor] (
    ...
    [Id]            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion] BIGINT           NOT NULL,
    CONSTRAINT [PK_Descriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DiagnosisDescriptor] (
    ...
    [Id]                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]         BIGINT           NOT NULL,
    CONSTRAINT [PK_DiagnosisDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DiplomaLevelDescriptor] (
    ...
    [Id]                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]            BIGINT           NOT NULL,
    CONSTRAINT [PK_DiplomaLevelDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DiplomaTypeDescriptor] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_DiplomaTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DisabilityDescriptor] (
    ...
    [Id]                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]          BIGINT           NOT NULL,
    CONSTRAINT [PK_DisabilityDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DisabilityDesignationDescriptor] (
    ...
    [Id]                                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                     BIGINT           NOT NULL,
    CONSTRAINT [PK_DisabilityDesignationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DisabilityDeterminationSourceTypeDescriptor] (
    ...
    [Id]                                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                                 BIGINT           NOT NULL,
    CONSTRAINT [PK_DisabilityDeterminationSourceTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DisciplineAction] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_DisciplineAction] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DisciplineActionLengthDifferenceReasonDescriptor] (
    ...
    [Id]                                                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                                      BIGINT           NOT NULL,
    CONSTRAINT [PK_DisciplineActionLengthDifferenceReasonDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DisciplineDescriptor] (
    ...
    [Id]                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]          BIGINT           NOT NULL,
    CONSTRAINT [PK_DisciplineDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DisciplineIncident] (
    ...
    [Id]                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]      BIGINT           NOT NULL,
    CONSTRAINT [PK_DisciplineIncident] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[DisciplineIncidentParticipationCodeDescriptor] (
    ...
    [Id]                                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                                   BIGINT           NOT NULL,
    CONSTRAINT [PK_DisciplineIncidentParticipationCodeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EducationalEnvironmentDescriptor] (
    ...
    [Id]                                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                      BIGINT           NOT NULL,
    CONSTRAINT [PK_EducationalEnvironmentDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EducationContent] (
    ...
    [Id]                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]     BIGINT           NOT NULL,
    CONSTRAINT [PK_EducationContent] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EducationOrganization] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_EducationOrganization] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EducationOrganizationCategoryDescriptor] (
    ...
    [Id]                                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                             BIGINT           NOT NULL,
    CONSTRAINT [PK_EducationOrganizationCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EducationOrganizationIdentificationSystemDescriptor] (
    ...
    [Id]                                                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                                         BIGINT           NOT NULL,
    CONSTRAINT [PK_EducationOrganizationIdentificationSystemDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EducationOrganizationInterventionPrescriptionAssociation] (
    ...
    [Id]                                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                                   BIGINT           NOT NULL,
    CONSTRAINT [PK_EducationOrganizationInterventionPrescriptionAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EducationOrganizationNetwork] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_EducationOrganizationNetwork] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EducationOrganizationNetworkAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_EducationOrganizationNetworkAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EducationOrganizationPeerAssociation] (
    ...
    [Id]                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]               BIGINT           NOT NULL,
    CONSTRAINT [PK_EducationOrganizationPeerAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EducationPlanDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_EducationPlanDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EducationServiceCenter] (
    ...
    [Id]                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]            BIGINT           NOT NULL,
    CONSTRAINT [PK_EducationServiceCenter] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ElectronicMailTypeDescriptor] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_ElectronicMailTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EmploymentStatusDescriptor] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_EmploymentStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EntryGradeLevelReasonDescriptor] (
    ...
    [Id]                                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                     BIGINT           NOT NULL,
    CONSTRAINT [PK_EntryGradeLevelReasonDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EntryTypeDescriptor] (
    ...
    [Id]                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]         BIGINT           NOT NULL,
    CONSTRAINT [PK_EntryTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[EventCircumstanceDescriptor] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_EventCircumstanceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ExitWithdrawTypeDescriptor] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_ExitWithdrawTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[FeederSchoolAssociation] (
    ...
    [Id]             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]  BIGINT           NOT NULL,
    CONSTRAINT [PK_FeederSchoolAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[GeneralStudentProgramAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_GeneralStudentProgramAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Grade] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_Grade] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[GradebookEntry] (
    ...
    [Id]                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]       BIGINT           NOT NULL,
    CONSTRAINT [PK_GradebookEntry] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[GradebookEntryTypeDescriptor] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_GradebookEntryTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[GradeLevelDescriptor] (
    ...
    [Id]                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]          BIGINT           NOT NULL,
    CONSTRAINT [PK_GradeLevelDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[GradePointAverageTypeDescriptor] (
    ...
    [Id]                                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                     BIGINT           NOT NULL,
    CONSTRAINT [PK_GradePointAverageTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[GradeTypeDescriptor] (
    ...
    [Id]                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]         BIGINT           NOT NULL,
    CONSTRAINT [PK_GradeTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[GradingPeriod] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_GradingPeriod] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[GradingPeriodDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_GradingPeriodDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[GraduationPlan] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_GraduationPlan] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[GraduationPlanTypeDescriptor] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_GraduationPlanTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[GunFreeSchoolsActReportingStatusDescriptor] (
    ...
    [Id]                                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                                BIGINT           NOT NULL,
    CONSTRAINT [PK_GunFreeSchoolsActReportingStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[HomelessPrimaryNighttimeResidenceDescriptor] (
    ...
    [Id]                                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                                 BIGINT           NOT NULL,
    CONSTRAINT [PK_HomelessPrimaryNighttimeResidenceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[HomelessProgramServiceDescriptor] (
    ...
    [Id]                                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                      BIGINT           NOT NULL,
    CONSTRAINT [PK_HomelessProgramServiceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[IdentificationDocumentUseDescriptor] (
    ...
    [Id]                                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                         BIGINT           NOT NULL,
    CONSTRAINT [PK_IdentificationDocumentUseDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[IncidentLocationDescriptor] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_IncidentLocationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[InstitutionTelephoneNumberTypeDescriptor] (
    ...
    [Id]                                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                              BIGINT           NOT NULL,
    CONSTRAINT [PK_InstitutionTelephoneNumberTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[InteractivityStyleDescriptor] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_InteractivityStyleDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[InternetAccessDescriptor] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_InternetAccessDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Intervention] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_Intervention] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[InterventionClassDescriptor] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_InterventionClassDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[InterventionEffectivenessRatingDescriptor] (
    ...
    [Id]                                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                               BIGINT           NOT NULL,
    CONSTRAINT [PK_InterventionEffectivenessRatingDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[InterventionPrescription] (
    ...
    [Id]                                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                              BIGINT           NOT NULL,
    CONSTRAINT [PK_InterventionPrescription] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[InterventionStudy] (
    ...
    [Id]                                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                       BIGINT           NOT NULL,
    CONSTRAINT [PK_InterventionStudy] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LanguageDescriptor] (
    ...
    [Id]                   UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]        BIGINT           NOT NULL,
    CONSTRAINT [PK_LanguageDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LanguageInstructionProgramServiceDescriptor] (
    ...
    [Id]                                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                                 BIGINT           NOT NULL,
    CONSTRAINT [PK_LanguageInstructionProgramServiceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LanguageUseDescriptor] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_LanguageUseDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LearningObjective] (
    ...
    [Id]                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]       BIGINT           NOT NULL,
    CONSTRAINT [PK_LearningObjective] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LearningStandard] (
    ...
    [Id]                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]      BIGINT           NOT NULL,
    CONSTRAINT [PK_LearningStandard] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LearningStandardCategoryDescriptor] (
    ...
    [Id]                                   UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                        BIGINT           NOT NULL,
    CONSTRAINT [PK_LearningStandardCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LearningStandardEquivalenceAssociation] (
    ...
    [Id]                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]            BIGINT           NOT NULL,
    CONSTRAINT [PK_LearningStandardEquivalenceAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LearningStandardEquivalenceStrengthDescriptor] (
    ...
    [Id]                                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                                   BIGINT           NOT NULL,
    CONSTRAINT [PK_LearningStandardEquivalenceStrengthDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LearningStandardScopeDescriptor] (
    ...
    [Id]                                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                     BIGINT           NOT NULL,
    CONSTRAINT [PK_LearningStandardScopeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LevelOfEducationDescriptor] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_LevelOfEducationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LicenseStatusDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_LicenseStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LicenseTypeDescriptor] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_LicenseTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LimitedEnglishProficiencyDescriptor] (
    ...
    [Id]                                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                         BIGINT           NOT NULL,
    CONSTRAINT [PK_LimitedEnglishProficiencyDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LocaleDescriptor] (
    ...
    [Id]                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]      BIGINT           NOT NULL,
    CONSTRAINT [PK_LocaleDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LocalEducationAgency] (
    ...
    [Id]                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]          BIGINT           NOT NULL,
    CONSTRAINT [PK_LocalEducationAgency] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[LocalEducationAgencyCategoryDescriptor] (
    ...
    [Id]                                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                            BIGINT           NOT NULL,
    CONSTRAINT [PK_LocalEducationAgencyCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Location] (
    ...
    [Id]                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]               BIGINT           NOT NULL,
    CONSTRAINT [PK_Location] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[MagnetSpecialProgramEmphasisSchoolDescriptor] (
    ...
    [Id]                                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                                  BIGINT           NOT NULL,
    CONSTRAINT [PK_MagnetSpecialProgramEmphasisSchoolDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[MediumOfInstructionDescriptor] (
    ...
    [Id]                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                   BIGINT           NOT NULL,
    CONSTRAINT [PK_MediumOfInstructionDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[MethodCreditEarnedDescriptor] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_MethodCreditEarnedDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[MigrantEducationProgramServiceDescriptor] (
    ...
    [Id]                                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                              BIGINT           NOT NULL,
    CONSTRAINT [PK_MigrantEducationProgramServiceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[MonitoredDescriptor] (
    ...
    [Id]                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]         BIGINT           NOT NULL,
    CONSTRAINT [PK_MonitoredDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[NeglectedOrDelinquentProgramDescriptor] (
    ...
    [Id]                                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                            BIGINT           NOT NULL,
    CONSTRAINT [PK_NeglectedOrDelinquentProgramDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[NeglectedOrDelinquentProgramServiceDescriptor] (
    ...
    [Id]                                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                                   BIGINT           NOT NULL,
    CONSTRAINT [PK_NeglectedOrDelinquentProgramServiceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[NetworkPurposeDescriptor] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_NetworkPurposeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ObjectiveAssessment] (
    ...
    [Id]                   UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]        BIGINT           NOT NULL,
    CONSTRAINT [PK_ObjectiveAssessment] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[OldEthnicityDescriptor] (
    ...
    [Id]                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]            BIGINT           NOT NULL,
    CONSTRAINT [PK_OldEthnicityDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[OpenStaffPosition] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_OpenStaffPosition] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[OperationalStatusDescriptor] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_OperationalStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[OtherNameTypeDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_OtherNameTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Parent] (
    ...
    [Id]            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion] BIGINT           NOT NULL,
    CONSTRAINT [PK_Parent] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ParticipationDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_ParticipationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ParticipationStatusDescriptor] (
    ...
    [Id]                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                   BIGINT           NOT NULL,
    CONSTRAINT [PK_ParticipationStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Payroll] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_Payroll] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[PerformanceBaseConversionDescriptor] (
    ...
    [Id]                                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                         BIGINT           NOT NULL,
    CONSTRAINT [PK_PerformanceBaseConversionDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[PerformanceLevelDescriptor] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_PerformanceLevelDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[PersonalInformationVerificationDescriptor] (
    ...
    [Id]                                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                               BIGINT           NOT NULL,
    CONSTRAINT [PK_PersonalInformationVerificationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[PlatformTypeDescriptor] (
    ...
    [Id]                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]            BIGINT           NOT NULL,
    CONSTRAINT [PK_PlatformTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[PopulationServedDescriptor] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_PopulationServedDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[PostingResultDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_PostingResultDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[PostSecondaryEvent] (
    ...
    [Id]                                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                          BIGINT           NOT NULL,
    CONSTRAINT [PK_PostSecondaryEvent] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[PostSecondaryEventCategoryDescriptor] (
    ...
    [Id]                                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                          BIGINT           NOT NULL,
    CONSTRAINT [PK_PostSecondaryEventCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[PostSecondaryInstitution] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_PostSecondaryInstitution] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[PostSecondaryInstitutionLevelDescriptor] (
    ...
    [Id]                                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                             BIGINT           NOT NULL,
    CONSTRAINT [PK_PostSecondaryInstitutionLevelDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ProficiencyDescriptor] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_ProficiencyDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Program] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_Program] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ProgramAssignmentDescriptor] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_ProgramAssignmentDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ProgramCharacteristicDescriptor] (
    ...
    [Id]                                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                     BIGINT           NOT NULL,
    CONSTRAINT [PK_ProgramCharacteristicDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ProgramSponsorDescriptor] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_ProgramSponsorDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ProgramTypeDescriptor] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_ProgramTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ProgressDescriptor] (
    ...
    [Id]                   UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]        BIGINT           NOT NULL,
    CONSTRAINT [PK_ProgressDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ProgressLevelDescriptor] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_ProgressLevelDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ProviderCategoryDescriptor] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_ProviderCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ProviderProfitabilityDescriptor] (
    ...
    [Id]                                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                     BIGINT           NOT NULL,
    CONSTRAINT [PK_ProviderProfitabilityDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ProviderStatusDescriptor] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_ProviderStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[PublicationStatusDescriptor] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_PublicationStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[RaceDescriptor] (
    ...
    [Id]               UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]    BIGINT           NOT NULL,
    CONSTRAINT [PK_RaceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ReasonExitedDescriptor] (
    ...
    [Id]                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]            BIGINT           NOT NULL,
    CONSTRAINT [PK_ReasonExitedDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ReasonNotTestedDescriptor] (
    ...
    [Id]                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]               BIGINT           NOT NULL,
    CONSTRAINT [PK_ReasonNotTestedDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[RecognitionTypeDescriptor] (
    ...
    [Id]                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]               BIGINT           NOT NULL,
    CONSTRAINT [PK_RecognitionTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[RelationDescriptor] (
    ...
    [Id]                   UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]        BIGINT           NOT NULL,
    CONSTRAINT [PK_RelationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[RepeatIdentifierDescriptor] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_RepeatIdentifierDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ReportCard] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_ReportCard] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ReporterDescriptionDescriptor] (
    ...
    [Id]                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                   BIGINT           NOT NULL,
    CONSTRAINT [PK_ReporterDescriptionDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ResidencyStatusDescriptor] (
    ...
    [Id]                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]               BIGINT           NOT NULL,
    CONSTRAINT [PK_ResidencyStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ResponseIndicatorDescriptor] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_ResponseIndicatorDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ResponsibilityDescriptor] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_ResponsibilityDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[RestraintEvent] (
    ...
    [Id]                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]            BIGINT           NOT NULL,
    CONSTRAINT [PK_RestraintEvent] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[RestraintEventReasonDescriptor] (
    ...
    [Id]                               UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                    BIGINT           NOT NULL,
    CONSTRAINT [PK_RestraintEventReasonDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ResultDatatypeTypeDescriptor] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_ResultDatatypeTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[RetestIndicatorDescriptor] (
    ...
    [Id]                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]               BIGINT           NOT NULL,
    CONSTRAINT [PK_RetestIndicatorDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[School] (
    ...
    [Id]            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion] BIGINT           NOT NULL,
    CONSTRAINT [PK_School] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[SchoolCategoryDescriptor] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_SchoolCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[SchoolChoiceImplementStatusDescriptor] (
    ...
    [Id]                                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                           BIGINT           NOT NULL,
    CONSTRAINT [PK_SchoolChoiceImplementStatusDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[SchoolFoodServiceProgramServiceDescriptor] (
    ...
    [Id]                                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                               BIGINT           NOT NULL,
    CONSTRAINT [PK_SchoolFoodServiceProgramServiceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[SchoolTypeDescriptor] (
    ...
    [Id]                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]          BIGINT           NOT NULL,
    CONSTRAINT [PK_SchoolTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Section] (
    ...
    [Id]                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]     BIGINT           NOT NULL,
    CONSTRAINT [PK_Section] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[SectionAttendanceTakenEvent] (
    ...
    [Id]                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]     BIGINT           NOT NULL,
    CONSTRAINT [PK_SectionAttendanceTakenEvent] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[SectionCharacteristicDescriptor] (
    ...
    [Id]                                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                     BIGINT           NOT NULL,
    CONSTRAINT [PK_SectionCharacteristicDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[SeparationDescriptor] (
    ...
    [Id]                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]          BIGINT           NOT NULL,
    CONSTRAINT [PK_SeparationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[SeparationReasonDescriptor] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_SeparationReasonDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[ServiceDescriptor] (
    ...
    [Id]                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]       BIGINT           NOT NULL,
    CONSTRAINT [PK_ServiceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Session] (
    ...
    [Id]            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion] BIGINT           NOT NULL,
    CONSTRAINT [PK_Session] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[SexDescriptor] (
    ...
    [Id]              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]   BIGINT           NOT NULL,
    CONSTRAINT [PK_SexDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[SpecialEducationProgramServiceDescriptor] (
    ...
    [Id]                                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                              BIGINT           NOT NULL,
    CONSTRAINT [PK_SpecialEducationProgramServiceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[SpecialEducationSettingDescriptor] (
    ...
    [Id]                                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                       BIGINT           NOT NULL,
    CONSTRAINT [PK_SpecialEducationSettingDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Staff] (
    ...
    [Id]            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion] BIGINT           NOT NULL,
    CONSTRAINT [PK_Staff] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffAbsenceEvent] (
    ...
    [Id]                               UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                    BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffAbsenceEvent] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffClassificationDescriptor] (
    ...
    [Id]                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                   BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffClassificationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffCohortAssociation] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffCohortAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffDisciplineIncidentAssociation] (
    ...
    [Id]                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]      BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffDisciplineIncidentAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffEducationOrganizationAssignmentAssociation] (
    ...
    [Id]                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                   BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffEducationOrganizationAssignmentAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffEducationOrganizationContactAssociation] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffEducationOrganizationContactAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffEducationOrganizationEmploymentAssociation] (
    ...
    [Id]                           UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffEducationOrganizationEmploymentAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffIdentificationSystemDescriptor] (
    ...
    [Id]                                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                         BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffIdentificationSystemDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffLeave] (
    ...
    [Id]                                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                       BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffLeave] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffLeaveEventCategoryDescriptor] (
    ...
    [Id]                                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                       BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffLeaveEventCategoryDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffProgramAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffProgramAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffSchoolAssociation] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffSchoolAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StaffSectionAssociation] (
    ...
    [Id]                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]     BIGINT           NOT NULL,
    CONSTRAINT [PK_StaffSectionAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StateAbbreviationDescriptor] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_StateAbbreviationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StateEducationAgency] (
    ...
    [Id]                     UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]          BIGINT           NOT NULL,
    CONSTRAINT [PK_StateEducationAgency] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[Student] (
    ...
    [Id]            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion] BIGINT           NOT NULL,
    CONSTRAINT [PK_Student] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentAcademicRecord] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentAcademicRecord] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentAssessment] (
    ...
    [Id]                          UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]               BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentAssessment] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentCharacteristicDescriptor] (
    ...
    [Id]                                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                     BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentCharacteristicDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentCohortAssociation] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentCohortAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentCompetencyObjective] (
    ...
    [Id]                               UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                    BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentCompetencyObjective] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentCTEProgramAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentCTEProgramAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentDisciplineIncidentAssociation] (
    ...
    [Id]                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]      BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentDisciplineIncidentAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentEducationOrganizationAssociation] (
    ...
    [Id]                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]           BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentEducationOrganizationAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentEducationOrganizationResponsibilityAssociation] (
    ...
    [Id]                         UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]              BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentEducationOrganizationResponsibilityAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentGradebookEntry] (
    ...
    [Id]                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]       BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentGradebookEntry] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentHomelessProgramAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentHomelessProgramAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentIdentificationSystemDescriptor] (
    ...
    [Id]                                      UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                           BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentIdentificationSystemDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentInterventionAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentInterventionAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentInterventionAttendanceEvent] (
    ...
    [Id]                                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                       BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentInterventionAttendanceEvent] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentLanguageInstructionProgramAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentLanguageInstructionProgramAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentLearningObjective] (
    ...
    [Id]                        UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]             BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentLearningObjective] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentMigrantEducationProgramAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentMigrantEducationProgramAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentNeglectedOrDelinquentProgramAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentNeglectedOrDelinquentProgramAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentParentAssociation] (
    ...
    [Id]            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion] BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentParentAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentParticipationCodeDescriptor] (
    ...
    [Id]                                   UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                        BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentParticipationCodeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentProgramAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentProgramAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentProgramAttendanceEvent] (
    ...
    [Id]                                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                       BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentProgramAttendanceEvent] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentSchoolAssociation] (
    ...
    [Id]            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion] BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentSchoolAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentSchoolAttendanceEvent] (
    ...
    [Id]                                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                       BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentSchoolAttendanceEvent] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentSchoolFoodServiceProgramAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentSchoolFoodServiceProgramAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentSectionAssociation] (
    ...
    [Id]                UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]     BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentSectionAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentSectionAttendanceEvent] (
    ...
    [Id]                                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                       BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentSectionAttendanceEvent] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentSpecialEducationProgramAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentSpecialEducationProgramAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[StudentTitleIPartAProgramAssociation] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_StudentTitleIPartAProgramAssociation] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[TeachingCredentialBasisDescriptor] (
    ...
    [Id]                                  UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                       BIGINT           NOT NULL,
    CONSTRAINT [PK_TeachingCredentialBasisDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[TeachingCredentialDescriptor] (
    ...
    [Id]                             UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                  BIGINT           NOT NULL,
    CONSTRAINT [PK_TeachingCredentialDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[TechnicalSkillsAssessmentDescriptor] (
    ...
    [Id]                                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                         BIGINT           NOT NULL,
    CONSTRAINT [PK_TechnicalSkillsAssessmentDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[TelephoneNumberTypeDescriptor] (
    ...
    [Id]                              UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                   BIGINT           NOT NULL,
    CONSTRAINT [PK_TelephoneNumberTypeDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[TermDescriptor] (
    ...
    [Id]               UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]    BIGINT           NOT NULL,
    CONSTRAINT [PK_TermDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[TitleIPartAParticipantDescriptor] (
    ...
    [Id]                                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                      BIGINT           NOT NULL,
    CONSTRAINT [PK_TitleIPartAParticipantDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[TitleIPartAProgramServiceDescriptor] (
    ...
    [Id]                                    UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                         BIGINT           NOT NULL,
    CONSTRAINT [PK_TitleIPartAProgramServiceDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[TitleIPartASchoolDesignationDescriptor] (
    ...
    [Id]                                       UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                            BIGINT           NOT NULL,
    CONSTRAINT [PK_TitleIPartASchoolDesignationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[TribalAffiliationDescriptor] (
    ...
    [Id]                            UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]                 BIGINT           NOT NULL,
    CONSTRAINT [PK_TribalAffiliationDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[VisaDescriptor] (
    ...
    [Id]               UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]    BIGINT           NOT NULL,
    CONSTRAINT [PK_VisaDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
...
CREATE TABLE [tracked_deletes_edfi].[WeaponDescriptor] (
    ...
    [Id]                 UNIQUEIDENTIFIER NOT NULL,
    [ChangeVersion]      BIGINT           NOT NULL,
    CONSTRAINT [PK_WeaponDescriptor] PRIMARY KEY CLUSTERED ([ChangeVersion] ASC)
);
GO
