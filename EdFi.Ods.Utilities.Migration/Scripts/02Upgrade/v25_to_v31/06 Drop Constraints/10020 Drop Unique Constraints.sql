...
EXEC [migration_tempdata].[sp_DropUniqueConstraints] 'edfi', 'AssessmentAcademicSubject'
GO

EXEC [migration_tempdata].[sp_DropUniqueConstraints] 'edfi', 'AssessmentAssessedGradeLevel'
GO
...
EXEC [migration_tempdata].[sp_DropUniqueConstraints] 'edfi', 'LearningObjectiveAcademicSubject'
GO
...
EXEC [migration_tempdata].[sp_DropUniqueConstraints] 'edfi', 'LearningObjectiveGradeLevel'
GO
