...
GO
ALTER TABLE [edfi].[LearningStandardContentStandardAuthor] ADD CONSTRAINT [LearningStandardContentStandardAuthor_PK] PRIMARY KEY CLUSTERED  ([Author], [LearningStandardId])
GO
