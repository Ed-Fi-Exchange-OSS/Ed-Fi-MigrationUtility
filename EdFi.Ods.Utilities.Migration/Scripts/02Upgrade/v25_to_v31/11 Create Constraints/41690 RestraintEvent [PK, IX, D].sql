...
GO
ALTER TABLE [edfi].[RestraintEvent] ADD CONSTRAINT [RestraintEvent_PK] PRIMARY KEY CLUSTERED  ([RestraintEventIdentifier], [SchoolId], [StudentUSI])
GO
...
PRINT N'Creating index [FK_RestraintEvent_EducationalEnvironmentDescriptor] on [edfi].[RestraintEvent]'
GO
CREATE NONCLUSTERED INDEX [FK_RestraintEvent_EducationalEnvironmentDescriptor] ON [edfi].[RestraintEvent] ([EducationalEnvironmentDescriptorId])
GO
