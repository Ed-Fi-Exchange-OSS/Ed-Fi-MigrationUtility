...
GO
ALTER TABLE [edfi].[CalendarDateCalendarEvent] ADD CONSTRAINT [CalendarDateCalendarEvent_PK] PRIMARY KEY CLUSTERED  ([CalendarCode], [CalendarEventDescriptorId], [Date], [SchoolId], [SchoolYear])
GO

PRINT N'Creating index [FK_CalendarDateCalendarEvent_CalendarDate] on [edfi].[CalendarDateCalendarEvent]'
GO
CREATE NONCLUSTERED INDEX [FK_CalendarDateCalendarEvent_CalendarDate] ON [edfi].[CalendarDateCalendarEvent] ([CalendarCode], [Date], [SchoolId], [SchoolYear])
GO
