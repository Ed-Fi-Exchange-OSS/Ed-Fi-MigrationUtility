...
GO
ALTER TABLE [edfi].[CalendarDate] ADD CONSTRAINT [CalendarDate_PK] PRIMARY KEY CLUSTERED  ([CalendarCode], [Date], [SchoolId], [SchoolYear])
GO
...
PRINT N'Creating index [FK_CalendarDate_Calendar] on [edfi].[CalendarDate]'
GO
CREATE NONCLUSTERED INDEX [FK_CalendarDate_Calendar] ON [edfi].[CalendarDate] ([CalendarCode], [SchoolId], [SchoolYear])
GO
