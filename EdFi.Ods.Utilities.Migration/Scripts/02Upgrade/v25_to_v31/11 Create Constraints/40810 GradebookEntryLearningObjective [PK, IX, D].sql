...
GO
ALTER TABLE [edfi].[GradebookEntryLearningObjective] ADD CONSTRAINT [GradebookEntryLearningObjective_PK] PRIMARY KEY CLUSTERED  ([DateAssigned], [GradebookEntryTitle], [LearningObjectiveId], [LocalCourseCode], [Namespace], [SchoolId], [SchoolYear], [SectionIdentifier], [SessionName])
GO

PRINT N'Creating index [FK_GradebookEntryLearningObjective_GradebookEntry] on [edfi].[GradebookEntryLearningObjective]'
GO
CREATE NONCLUSTERED INDEX [FK_GradebookEntryLearningObjective_GradebookEntry] ON [edfi].[GradebookEntryLearningObjective] ([DateAssigned], [GradebookEntryTitle], [LocalCourseCode], [SchoolId], [SchoolYear], [SectionIdentifier], [SessionName])
GO
