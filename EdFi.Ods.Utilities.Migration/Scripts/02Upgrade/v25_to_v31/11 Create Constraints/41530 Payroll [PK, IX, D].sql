...
GO
ALTER TABLE [edfi].[Payroll] ADD CONSTRAINT [Payroll_PK] PRIMARY KEY CLUSTERED  ([AccountIdentifier], [AsOfDate], [EducationOrganizationId], [FiscalYear], [StaffUSI])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_Payroll_Account] ON [edfi].[Payroll] ([AccountIdentifier], [EducationOrganizationId], [FiscalYear])
GO
