...
GO
ALTER TABLE [edfi].[InterventionDiagnosis] ADD CONSTRAINT [InterventionDiagnosis_PK] PRIMARY KEY CLUSTERED  ([DiagnosisDescriptorId], [EducationOrganizationId], [InterventionIdentificationCode])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_InterventionDiagnosis_Intervention] ON [edfi].[InterventionDiagnosis] ([EducationOrganizationId], [InterventionIdentificationCode])
GO
