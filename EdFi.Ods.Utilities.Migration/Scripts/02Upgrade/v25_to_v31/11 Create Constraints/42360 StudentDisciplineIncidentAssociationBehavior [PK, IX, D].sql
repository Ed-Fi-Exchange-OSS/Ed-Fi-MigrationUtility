...
GO
ALTER TABLE [edfi].[StudentDisciplineIncidentAssociationBehavior] ADD CONSTRAINT [StudentDisciplineIncidentAssociationBehavior_PK] PRIMARY KEY CLUSTERED  ([BehaviorDescriptorId], [IncidentIdentifier], [SchoolId], [StudentUSI])
GO
...
GO
CREATE NONCLUSTERED INDEX [FK_StudentDisciplineIncidentAssociationBehavior_StudentDisciplineIncidentAssociation] ON [edfi].[StudentDisciplineIncidentAssociationBehavior] ([IncidentIdentifier], [SchoolId], [StudentUSI])
GO
