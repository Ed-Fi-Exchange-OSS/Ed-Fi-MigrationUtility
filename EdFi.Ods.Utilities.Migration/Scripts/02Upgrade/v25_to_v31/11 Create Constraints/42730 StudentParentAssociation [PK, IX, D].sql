...
GO
ALTER TABLE [edfi].[StudentParentAssociation] ADD CONSTRAINT [StudentParentAssociation_PK] PRIMARY KEY CLUSTERED  ([ParentUSI], [StudentUSI])
GO
...
PRINT N'Creating index [FK_StudentParentAssociation_RelationDescriptor] on [edfi].[StudentParentAssociation]'
GO
CREATE NONCLUSTERED INDEX [FK_StudentParentAssociation_RelationDescriptor] ON [edfi].[StudentParentAssociation] ([RelationDescriptorId])
GO
