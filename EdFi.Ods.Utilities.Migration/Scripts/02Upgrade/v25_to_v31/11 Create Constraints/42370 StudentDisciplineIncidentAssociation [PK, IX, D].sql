...
GO
ALTER TABLE [edfi].[StudentDisciplineIncidentAssociation] ADD CONSTRAINT [StudentDisciplineIncidentAssociation_PK] PRIMARY KEY CLUSTERED  ([IncidentIdentifier], [SchoolId], [StudentUSI])
GO
...
PRINT N'Creating index [FK_StudentDisciplineIncidentAssociation_StudentParticipationCodeDescriptor] on [edfi].[StudentDisciplineIncidentAssociation]'
GO
CREATE NONCLUSTERED INDEX [FK_StudentDisciplineIncidentAssociation_StudentParticipationCodeDescriptor] ON [edfi].[StudentDisciplineIncidentAssociation] ([StudentParticipationCodeDescriptorId])
GO
