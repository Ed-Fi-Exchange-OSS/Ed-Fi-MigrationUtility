...
GO
ALTER TABLE [edfi].[StaffElectronicMail] ADD CONSTRAINT [StaffElectronicMail_PK] PRIMARY KEY CLUSTERED  ([ElectronicMailTypeDescriptorId], [StaffUSI])
GO

PRINT N'Creating index [FK_StaffElectronicMail_ElectronicMailTypeDescriptor] on [edfi].[StaffElectronicMail]'
GO
CREATE NONCLUSTERED INDEX [FK_StaffElectronicMail_ElectronicMailTypeDescriptor] ON [edfi].[StaffElectronicMail] ([ElectronicMailTypeDescriptorId])
GO
