...
GO
ALTER TABLE [edfi].[DisciplineIncidentWeapon] ADD CONSTRAINT [DisciplineIncidentWeapon_PK] PRIMARY KEY CLUSTERED  ([IncidentIdentifier], [SchoolId], [WeaponDescriptorId])
GO
