...
GO
ALTER TABLE [edfi].[StaffEducationOrganizationEmploymentAssociation] ADD CONSTRAINT [StaffEducationOrganizationEmploymentAssociation_PK] PRIMARY KEY CLUSTERED  ([EducationOrganizationId], [EmploymentStatusDescriptorId], [HireDate], [StaffUSI])
GO
...
PRINT N'Creating index [FK_StaffEducationOrganizationEmploymentAssociation_Credential] on [edfi].[StaffEducationOrganizationEmploymentAssociation]'
GO
CREATE NONCLUSTERED INDEX [FK_StaffEducationOrganizationEmploymentAssociation_Credential] ON [edfi].[StaffEducationOrganizationEmploymentAssociation] ([CredentialIdentifier], [StateOfIssueStateAbbreviationDescriptorId])
GO
...
PRINT N'Creating index [FK_StaffEducationOrganizationEmploymentAssociation_SeparationDescriptor] on [edfi].[StaffEducationOrganizationEmploymentAssociation]'
GO
CREATE NONCLUSTERED INDEX [FK_StaffEducationOrganizationEmploymentAssociation_SeparationDescriptor] ON [edfi].[StaffEducationOrganizationEmploymentAssociation] ([SeparationDescriptorId])
GO
