...
PRINT N'Converting namespace to v3 format on [edfi].[LearningObjectiveGradeLevel]'
GO

UPDATE [edfi].[LearningObjectiveGradeLevel]
SET
...
INNER JOIN [edfi].[LearningObjectiveGradeLevel] l
