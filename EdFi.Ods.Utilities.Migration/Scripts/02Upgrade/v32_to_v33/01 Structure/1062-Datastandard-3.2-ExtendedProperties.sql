...
IF EXISTS(SELECT 1 FROM::fn_listextendedproperty('MS_Description', 'schema', 'edfi', 'table', 'ProgressDescriptor', null, null))
    EXEC sys.sp_dropextendedproperty 'MS_Description', 'schema', 'edfi', 'table', 'ProgressDescriptor'
    EXEC sp_addextendedproperty @name = N'MS_Description', @value = N'This descriptor defines yearly progress or growth from last year''s assessment.', @level0type = N'SCHEMA', @level0name = N'edfi', @level1type = N'TABLE', @level1name = N'ProgressDescriptor'
GO
...
IF EXISTS(SELECT 1 FROM::fn_listextendedproperty('MS_Description', 'schema', 'edfi', 'table', 'DisciplineAction', 'column', 'IEPPlacementMeetingIndicator'))
...
IF EXISTS(SELECT 1 FROM::fn_listextendedproperty('MS_Description', 'schema', 'edfi', 'table', 'StudentLanguageInstructionProgramAssociationEnglishLanguageProficiencyAssessment', 'column', 'ProgressDescriptorId'))
...
IF EXISTS(SELECT 1 FROM::fn_listextendedproperty('MS_Description', 'schema', 'edfi', 'table', 'StudentMigrantEducationProgramAssociation', 'column', 'EligibilityExpirationDate'))
...
IF EXISTS(SELECT 1 FROM::fn_listextendedproperty('MS_Description', 'schema', 'edfi', 'table', 'StudentMigrantEducationProgramAssociation', 'column', 'QualifyingArrivalDate'))
