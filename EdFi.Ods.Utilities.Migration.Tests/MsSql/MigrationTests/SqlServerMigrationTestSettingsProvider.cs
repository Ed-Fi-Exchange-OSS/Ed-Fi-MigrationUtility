...
{
    public static class SqlServerMigrationTestSettingsProvider
    {
        ...
        static SqlServerMigrationTestSettingsProvider()
        {
            Config = new Lazy<IConfigurationRoot>(() => new ConfigurationBuilder()
                .SetBasePath(Directory.GetParent(AppContext.BaseDirectory).FullName)
                .AddJsonFile("appsettings.json", optional: true, reloadOnChange: true)
                .AddJsonFile("appsettings.mssql.json", optional: true, reloadOnChange: true)
                .Build());
        }
