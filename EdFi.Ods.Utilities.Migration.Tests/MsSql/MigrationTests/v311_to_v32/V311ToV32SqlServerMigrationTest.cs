...
using EdFi.Ods.Utilities.Migration.Tests.Models.v32;

namespace EdFi.Ods.Utilities.Migration.Tests.MsSql.MigrationTests.v311_to_v32
{
    public abstract class V311ToV32SqlServerMigrationTest : SqlServerMigrationTestBase
    {
        ...
        protected OdsUpgradeResult PerformTestMigration(string sourceDataScriptName = null, DynamicParameters scriptParameters = null, string calendarConfigurationFileName = null, string namespacePrefix = null)
        {
            ...
            var migrationManager = new OdsMigrationManagerV311ToV32(config, versionConfiguration, SqlServerMigrationTestsGlobalSetup.UpgradeEngineBuilderProvider);
