...
namespace EdFi.Ods.Utilities.Migration.Tests.MsSql.MigrationTests.v24_to_v25.DataCompatibilityErrorTests
{
    [TestFixture]
    public class DataCompatibilityErrorTests : V24ToV25SqlServerMigrationTest
    {
