...
{
    [TestFixture]
    public abstract class GrandBendTests : SqlServerMigrationTestBase
    {
        ...
        {
            var grandBendBackupPathsByVersion = SqlServerMigrationTestSettingsProvider.GetGrandBendBackupPaths();
        ...
        public void Setup()
        {
            ...
            var options = new Options
            {
                ...
                CalendarConfigFilePath = Path.GetFullPath(
                    Path.Combine(
                        SqlServerMigrationTestSettingsProvider.GetConfigVariable("BaseCalendarConfigPath"),
            ...
            var upgradeConfiguration =
                SqlServerMigrationTestsGlobalSetup.MigrationConfigurationProvider.Get(options, null,
                    ToVersion.ToString());
            ...
            var migrationManager = SqlServerMigrationTestsGlobalSetup.OdsMigrationManagerFactory(options, upgradeConfiguration)
                .CreateManagers();
