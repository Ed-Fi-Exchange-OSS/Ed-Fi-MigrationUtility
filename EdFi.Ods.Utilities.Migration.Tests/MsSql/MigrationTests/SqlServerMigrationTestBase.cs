...
{
    public abstract class SqlServerMigrationTestBase : SqlServerDatabaseIntegrationTestBase
    {
        ...
        protected virtual void AssertUpgradeSucceeded(OdsUpgradeResult result)
        {
            ...
            if (SchemaMetadataCheckEnabled())
            {
                ...
                schemaMetadata.AssertSchemaContainsAllExpectedObjects(new SqlServerDatabaseConnectionProvider(),
        ...
        private void ExecuteOdsScripts(EdFiOdsVersion version)
        {
            ...
            string dbDeployName = SqlServerMigrationTestSettingsProvider.GetConfigVariable("DbDeployName");
            string dbDeployVersion = SqlServerMigrationTestSettingsProvider.GetConfigVariable("DbDeployVersion");
            string dbDeployPath = SqlServerMigrationTestSettingsProvider.GetConfigVariable("DbDeployPath");
            string dbDeploySource = SqlServerMigrationTestSettingsProvider.GetConfigVariable("DbDeploySource");
        ...
        private void ExecuteOdsScriptsForFeature(EdFiOdsVersion version, EdFiOdsFeature feature)
        {
            ...
            var structureScriptPaths = allJournalEntries
                .Where(je => je.ScriptType == "Structure"
                             ...
                             && je.DatabaseEngine == DatabaseEngine.SqlServer.ScriptsFolderName)
                .Select(
        ...
        private bool SchemaMetadataCheckEnabled()
        {
            var versionsNotYetComplete =
                SqlServerMigrationTestSettingsProvider
        ...
        private void DisableTestIfFilteredByVersionConfiguration()
        {
            ...
            if (!testIsEnabled)
            {
                var fromVersionConfigSetting = SqlServerMigrationTestSettingsProvider.GetConfigVariable("FromVersion");
                var toVersionConfigSetting = SqlServerMigrationTestSettingsProvider.GetConfigVariable("ToVersion");
