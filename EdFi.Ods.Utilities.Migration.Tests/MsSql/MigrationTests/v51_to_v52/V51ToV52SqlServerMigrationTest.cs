...
namespace EdFi.Ods.Utilities.Migration.Tests.MsSql.MigrationTests.v51_to_v52
{
    public abstract class V51ToV52SqlServerMigrationTest : SqlServerMigrationTestBase
    {
        ...
        protected OdsUpgradeResult PerformTestMigration(string sourceDataScriptName = null, DynamicParameters scriptParameters = null, string calendarConfigurationFileName = null, string namespacePrefix = null)
        {
            ...
            var migrationManager = new OdsMigrationManagerV51ToV52(config, versionConfiguration, SqlServerMigrationTestsGlobalSetup.UpgradeEngineBuilderProvider);
