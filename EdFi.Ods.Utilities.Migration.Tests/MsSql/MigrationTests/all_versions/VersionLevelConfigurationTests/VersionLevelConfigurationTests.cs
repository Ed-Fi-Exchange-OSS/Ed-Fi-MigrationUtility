...
namespace EdFi.Ods.Utilities.Migration.Tests.MsSql.MigrationTests.all_versions.VersionLevelConfigurationTests
{
    /// <summary>
    ...
    /// </summary>
    [TestFixture]
    public class VersionLevelConfigurationTests : SqlServerDatabaseIntegrationTestBase
    {
