...
{
    [TestFixture]
    public class EdFiOdsVersionJournalTests : SqlServerDatabaseIntegrationTestBase
    {
        ...
        public void MigrationUtilityScriptsShouldBeUpToDateWithCurrentEdFiOdsBuild()
        {
            ...
            var currentEdFiOdsScriptDirectoryRoot =
                SqlServerMigrationTestSettingsProvider.GetConfigVariable("CurrentEdFiOdsScriptDirectory");
