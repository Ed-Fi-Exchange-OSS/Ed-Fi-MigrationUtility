...
{
    public abstract class SqlServerDatabaseIntegrationTestBase
    {
        private readonly ILog _logger = LogManager.GetLogger(typeof(SqlServerDatabaseIntegrationTestBase));

        protected string DatabaseName = "EdFi_Ods_Migration_Test";

        protected string ConnectionString => SqlServerMigrationTestSettingsProvider.GetConnectionString(DatabaseName);

        protected static int SqlCommandTimeout => int.Parse(SqlServerMigrationTestSettingsProvider.GetConfigVariable("SqlCommandTimeout"));
        ...
        protected void DropTestDatabase()
        {
            ...
            using (var connection = new SqlConnection(SqlServerMigrationTestSettingsProvider.GetConnectionString("RestoreBackupOnly")))
            {
        ...
        {
            var versionConfiguration = SqlServerMigrationTestSettingsProvider.GetConfigVariable(configurationVariable);
