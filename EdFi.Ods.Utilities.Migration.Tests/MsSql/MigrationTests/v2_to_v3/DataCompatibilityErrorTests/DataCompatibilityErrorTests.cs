...
namespace EdFi.Ods.Utilities.Migration.Tests.MsSql.MigrationTests.v2_to_v3.DataCompatibilityErrorTests
{
    [TestFixture]
    public class DataCompatibilityErrorTests : V2ToV3SqlServerMigrationTest
    {
