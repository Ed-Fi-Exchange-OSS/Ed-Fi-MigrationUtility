...
namespace EdFi.Ods.Utilities.Migration.Tests.MsSql.MigrationTests.v2_to_v3.StudentEducationOrganizationAssociationTests
{
    [TestFixture]
    public class StudentEducationOrganizationAssociationTests : V2ToV3SqlServerMigrationTest
    {
