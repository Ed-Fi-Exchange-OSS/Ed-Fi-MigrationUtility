...
namespace EdFi.Ods.Utilities.Migration.Tests.MsSql.MigrationTests.v2_to_v3.DefaultDescriptorTests
{
    [TestFixture]
    public class DefaultDescriptorTests : V2ToV3SqlServerMigrationTest
    {
