...
namespace EdFi.Ods.Utilities.Migration.Tests.MsSql.MigrationTests.v2_to_v3.DescriptorToTypeConversionTests
{
    [TestFixture]
    public class DescriptorToTypeConversionTests : V2ToV3SqlServerMigrationTest
    {
