...
namespace EdFi.Ods.Utilities.Migration.Tests.MsSql.MigrationTests.v2_to_v3.CalendarDefaultSchoolYearErrorTests
{
    [TestFixture]
    public class CalendarDefaultSchoolYearErrorTests : V2ToV3SqlServerMigrationTest
    {
