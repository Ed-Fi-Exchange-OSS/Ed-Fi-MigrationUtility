...
namespace EdFi.Ods.Utilities.Migration.Tests.MigrationTests.v2_to_v3.CalendarConfigErrorTests
{
    [TestFixture]
    public class CalendarConfigErrorTests : V2ToV3MigrationTest
    {
