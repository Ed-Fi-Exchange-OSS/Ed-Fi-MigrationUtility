...
namespace EdFi.Ods.Utilities.Migration.Tests.MigrationTests.v2_to_v3.DescriptorNamespaceTests
{
    [TestFixture]
    public class DescriptorNamespaceTests : V2ToV3MigrationTest
    {
