...
using EdFi.Ods.Utilities.Migration.PostgreSql.Tests.Enumerations;
using EdFi.Ods.Utilities.Migration.PostgreSql.Tests.MigrationTests.Models;
using EdFi.Ods.Utilities.Migration.PostgreSql.Tests.Utilities;
    ...
    public abstract class MigrationTestBase : DatabaseIntegrationTestBase
    {
        ...
        protected virtual void AssertUpgradeSucceeded(OdsUpgradeResult result)
        {
            ...
            if (SchemaMetadataCheckEnabled())
            {
                ...
                schemaMetadata.AssertSchemaContainsAllExpectedObjects(new PostgreSqlDatabaseConnectionProvider(), ConnectionString, TestToVersion.Version);
            }
        }
